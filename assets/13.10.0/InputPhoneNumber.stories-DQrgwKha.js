import{j as e,B,S as j,L as I,c as C,h as L,s as S,V as D}from"./ScrollView--WheKJHA.js";import{a as E}from"./LakeButton-DRgNhDHx.js";import{L as W}from"./LakeLabel-D_hE2FL1.js";import{u as _}from"./index-CsTT5knk.js";import{L as A}from"./LakeTextInput-B5A-KOoC.js";import{r as x}from"./iframe-xxUmpkKQ.js";import{p as O,b as w}from"./countries-CFqn5DWk.js";import{P as z}from"./PhoneCountryPicker-CqUjM1i2.js";import{S as G,a}from"./_StoriesComponents-CUU72-DH.js";import"./index-BHr7rC5l.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-CV79c5H0.js";import"./index-dllZPdRg.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-DVbOhyzs.js";import"./LakeSelect-DAPDv7Yr.js";import"./useBoolean-Cgjy_VMy.js";import"./useDisclosure-C7a-VcDt.js";import"./FocusTrap-DFpknuVc.js";import"./array-BfAlyugE.js";import"./FlatList-BndP4mf2.js";import"./Popover-DCIFQri5.js";import"./useResponsive-BJXCjB05.js";import"./function-DZOPYWcp.js";import"./BottomPanel-Ix3Wh2dB.js";import"./useBodyClassName-LrmBPIV5.js";import"./Suspendable-Dt78ol7Q.js";import"./TransitionView-D1S7nwL8.js";import"./index-BrbiCmCu.js";import"./Separator-C0ulLd11.js";import"./preload-helper-D1IIBeq1.js";import"./string-C5dL2Tvh.js";import"./i18n-CEtUHc9c.js";import"./rifm-CeSN7ZrZ.js";import"./Flag-DOus7Xzr.js";const k=S.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:d,id:c,country:p,value:y,countries:g,error:n,help:f,valid:r=!1,autofocus:t=!1,disabled:i=!1,readOnly:s=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:u,onSubmitEditing:T,onBlur:N})=>{const l=x.useRef(null),R=P=>{const F=P.replace(/[^ +0-9-()]/g,"");P===F&&u(P)};x.useEffect(()=>{t&&l.current&&setTimeout(()=>l.current?.focus(),250)},[t]),x.useImperativeHandle(d,()=>({focus:()=>l.current?.focus(),blur:()=>l.current?.blur()}),[]);const V=[k.picker,(i||s)&&k.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:p,countries:g??O,onValueChange:v,disabled:i,readOnly:s,error:n,ariaLabel:b,style:V}),e.jsx(A,{id:c,ref:l,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:y,valid:r,error:n,disabled:i,readOnly:s,onChangeText:R,onSubmitEditing:T,onBlur:N,style:k.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(j,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(n)?C.negative[500]:C.gray[500],children:n??f??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-DQrgwKha.js.map
