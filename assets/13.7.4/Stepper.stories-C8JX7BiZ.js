import{M as c,z as r,j as t,L as q,c as a,S as f,V as _,s as N,W as P,B as O,i as w}from"./ScrollView-jGRULhPA.js";import{r as z}from"./iframe-Dbes4E_G.js";import{a as I}from"./LakeButton-CevZs5AP.js";import{L as W}from"./Link-adPlwtV2.js";import{G as k}from"./Grid-y-HaF1Yw.js";import"./LakeHeading-DNKHS5ZM.js";import{S as D}from"./_StoriesComponents-DeYer64O.js";import"./index-vbg_nrXY.js";import"./preload-helper-D1IIBeq1.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-UBdkkbMZ.js";import"./index-BhiyNB8W.js";import"./extends-CF3RwP-h.js";import"./Separator-CcmUuj-K.js";const F={textDecoration:"none"},p=N.create({container:{alignItems:"flex-end"},bar:{width:"100%",height:4,borderRadius:2,backgroundColor:a.gray[100],overflow:"hidden",transformOrigin:"bottom",transform:"scaleY(0.5)",transitionDuration:"300ms",transitionProperty:"transform"},barActive:{transform:"scaleY(1)"},progressBar:{width:"100%",height:"100%",backgroundColor:a.current[500],transformOrigin:"left",transform:"scaleX(0)",transitionDuration:"300ms"},progressBarDone:{transform:"scaleX(1)"},progressBarError:{backgroundColor:a.negative[500]},mobileContainer:{borderBottomWidth:1,borderBottomColor:a.gray[100],paddingBottom:10},mobileNumber:{minWidth:28,height:24,borderRadius:12,borderWidth:1,borderColor:a.current[100],backgroundColor:a.current[50]},mobileNumberError:{borderColor:a.negative[100],backgroundColor:a.negative[50]}}),T=({to:s,disabled:i,style:l,children:o})=>i?t.jsx("span",{style:l,children:o}):t.jsx(W,{to:s,style:l,children:o}),S=({steps:s,activeStepId:i,style:l})=>{const o=s.flatMap(n=>c(n).with({id:r.string},({id:h})=>[h]).with({children:r.array(r.any)},({children:h})=>h.map(({id:x})=>x)).exhaustive()),u=o.indexOf(i);return t.jsx(k,{numColumns:s.length,horizontalSpace:12,style:[p.container,l],children:s.map((n,h)=>{const x=h+1,B=c(n).with({id:r.string},({id:e})=>e).with({children:r.array(r.any)},({children:e})=>e[0]?.id??"").exhaustive(),v=c(n).with({id:i},()=>!0).with({children:r.array(r.any)},({children:e})=>e.some(({id:d})=>d===i)).otherwise(()=>!1),y=c(n).with({id:r.string},({id:e})=>o.indexOf(e)<u).with({children:r.array(r.any)},({children:e})=>e.every(({id:d})=>o.indexOf(d)<u)).exhaustive(),C=c(n).with({hasErrors:!0},()=>!0).with({children:r.array(r.any)},({children:e})=>e.some(({hasErrors:d})=>d===!0)).otherwise(()=>!1),E=c(n).with({id:r.string},({url:e})=>e).with({children:r.array(r.any)},({children:e})=>e[0]?.url??"").exhaustive(),b=c(n).with({id:r.string},e=>[e]).with({children:r.array(r.any)},({children:e})=>e).exhaustive();return t.jsxs(T,{to:E,disabled:!y,style:F,children:[t.jsxs(q,{variant:v?"medium":"regular",color:C&&(y||v)?a.negative[500]:v||y?a.current[500]:a.gray[300],children:[x,". ",n.label]}),t.jsx(f,{height:12}),t.jsx(k,{numColumns:b.length,horizontalSpace:12,children:b.map(e=>{const d=e.id===i,L=o.indexOf(e.id)<u,A=e.hasErrors===!0;return t.jsx(_,{style:[p.bar,d&&p.barActive],children:t.jsx(_,{style:[p.progressBar,(d||L)&&p.progressBarDone,A&&p.progressBarError]})},e.id)})})]},B)})})};S.__docgenInfo={description:"",methods:[],displayName:"LakeStepper",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"Step | StepWithChildren",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  label: string;
  url: string;
  hasErrors?: boolean;
...
//# sourceMappingURL=Stepper.stories-C8JX7BiZ.js.map
