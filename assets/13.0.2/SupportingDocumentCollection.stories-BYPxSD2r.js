import{$ as ye,y as fe,p as Q,j as e,z as E,i as B,S as k,L as T,c as we,q as ve,s as De,aa as Z,ab as ee}from"./ScrollView-vEi5sUNw.js";import{a as X,L as C}from"./LakeButton-ChacF7oB.js";import{r as i}from"./iframe-DG43haB4.js";import{c as Se}from"./commonStyles-BBEkV6IC.js";import{L as Pe}from"./LakeCopyButton-DukehB6c.js";import{L as Y}from"./LakeLabel-DC6xkG4A.js";import{R as he}from"./ReadOnlyFieldList-BYF6QLiC.js";import{t as s,m as ke,v as qe,l as Ie,i as te}from"./i18n-BTrK-e19.js";import{F as je}from"./FilesUploader-CyCzLpPD.js";import{L as V}from"./LakeModal-CDQEK32N.js";import{S as p,a as m}from"./_StoriesComponents-CHJyVucJ.js";import"./index-AsoTAYPq.js";import"./Pressable-Wk72diXs.js";import"./index-BvsumAJm.js";import"./extends-CF3RwP-h.js";import"./preload-helper-D1IIBeq1.js";import"./clipboard-BXAk6GqW.js";import"./v4-BKrj-4V8.js";import"./Separator-ZzbVwDxr.js";import"./rifm-DCqVz9MG.js";import"./array-BfAlyugE.js";import"./FileInput-BfcxdJW3.js";import"./LakeHeading-DEiNgUhA.js";import"./useBoolean-Cm4047_8.js";import"./LakeAlert-BOl59qq8.js";import"./useResponsive-D8PAvwFN.js";import"./Tag-B8-1NzWT.js";import"./index-DmSIj1BJ.js";import"./FocusTrap-D_LEEieo.js";import"./Suspendable-CBKT7bWb.js";import"./ResponsiveContainer-6Ujwzsep.js";import"./TransitionView-DS8KMi-M.js";import"./useBodyClassName-DDH4xM2A.js";const ne=i.memo(({ref:n,style:r,onReset:l,onSubmit:v,...S})=>ye("form",{...S,ref:n,onReset:f=>{f.preventDefault(),l?.(f)},onSubmit:f=>{f.preventDefault(),v?.(f)},style:[Se.view,r]}));ne.displayName="Form";const be=["application/pdf","image/png","image/jpeg","image/heic"],L=De.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:"default"}}),_=n=>E(n).with({type:"tooltip"},({text:r,width:l})=>e.jsx(ve,{content:r,width:l,togglableOnFocus:!0,placement:"right",maxWidth:400,children:e.jsx(C,{mode:"tertiary",size:"small",color:"gray",icon:n.icon??"question-circle-regular",disabled:!0,style:[L.button,L.buttonWithDefaultCursor],ariaLabel:s("supportingDocuments.help.whatIsThis")})})).with({type:"button"},({label:r,onPress:l})=>e.jsx(C,{mode:"tertiary",size:"small",color:"gray",icon:n.icon??"question-circle-regular",onPress:l,style:L.button,ariaLabel:s("supportingDocuments.help.whatIsThis"),children:r})).exhaustive(),Re=n=>{const r=`supportingDocuments.purpose.${n}`;return te(r)?s(r):n},Ue=n=>{const r=`supportingDocuments.purpose.${n}.description`;return te(r)?s(r):""},d=({ref:n,documents:r,generateUpload:l,uploadFile:v,requiredDocumentPurposes:S,templateLanguage:f=Ie.language,status:re,onRemoveFile:oe,showIds:ae=!1,readOnly:W=!1,getPurposeMetadata:se,readonlyDocumentPurposes:ue=[],purposeLabelOverrides:ie,purposeDescriptionLabelOverrides:le})=>{const[de,N]=i.useState(!1),[pe,M]=i.useState(!1),[z,$]=i.useState(void 0),[P,me]=i.useState([]),H=i.useMemo(()=>{const t=new Set(S),u=[...P,...r];u.forEach(o=>t.add(o.purpose));const g=new Map([...t].map(o=>{const a=u.filter(y=>y.purpose===o);return[o,a]})),D=new Set(S),w=new Map([...t].map(o=>{const a=g.get(o)??[],A=a.length>0&&a.every(h=>h.file.statusInfo.status==="Validated")?0:D.has(o)?1:2;return[o,A]}));return[...t].sort((o,a)=>{const y=w.get(o)??2;return(w.get(a)??2)>y?-1:1}).map(o=>{const a=g.get(o)??[];return{purpose:o,files:a.map(y=>y.file),isRequired:D.has(o),areAllDocumentsValidated:w.get(o)===0}})},[S,r,P]),G=i.useRef(new Map(fe.filterMap(H,({isRequired:t,purpose:u,files:g})=>t?Q.Some([u,g]):Q.None()))),K=i.useRef({});i.useImperativeHandle(n,()=>({areAllRequiredDocumentsFilled:()=>[...G.current.values()].every(u=>u.length>0),addDocument:t=>{me(u=>[...u,t])}})),i.useEffect(()=>{const t=P[P.length-1];if(t!=null){const u=K.current[t?.purpose];u?.add(t.file)}},[P]);const J=H.filter(({files:t})=>!(W&&t.length===0));return e.jsxs(ne,{children:[J.map(({purpose:t,files:u,areAllDocumentsValidated:g,isRequired:D})=>{const w=se?.(t),o=le?.[t]??Ue(t);return e.jsxs(i.Fragment,{children:[e.jsx(Y,{label:ie?.[t]??Re(t),description:o,help:B(w)?e.jsx(_,{type:"button",label:w.title,onPress:()=>$(w)}):E(t).with("PowerOfAttorney",()=>e.jsx(_,{type:"button",icon:"arrow-down-filled",label:s("supportingDocuments.help.downloadTemplate"),onPress:()=>N(!0)})).with("SwornStatement",()=>e.jsx(_,{type:"button",icon:"arrow-down-filled",label:s("supportingDocuments.help.downloadTemplate"),onPress:()=>M(!0)})).otherwise(()=>null),render:()=>e.jsx(je,{ref:a=>{K.current[t]=a},canUpload:!ue.includes(t)&&!W&&re==="WaitingForDocument"&&!g,accept:be,maxSize:2e7,icon:"document-regular",initialFiles:u,generateUpload:l,getUploadConfig:a=>({fileName:a.name,purpose:t}),uploadFile:B(v)?v:({upload:a,file:y,onProgress:A})=>{const h=new FormData;return a.fields.forEach(({key:ce,value:ge})=>h.append(ce,ge)),h.append("file",y),setTimeout(()=>A(.8),100),ke.make({url:a.url,method:"POST",body:h,type:"text"}).mapOkToResult(qe)},formatAndSizeDescription:s("supportingDocuments.documentTypes",{maxSizeMB:2e7/1e6}),onRemoveFile:W?void 0:oe,onChange:a=>{D&&G.current.set(t,a)},showIds:ae})}),e.jsx(k,{height:24})]},t)}),J.length===0?e.jsxs(e.Fragment,{children:[e.jsx(k,{height:24}),e.jsx(T,{align:"center",children:s("supportingDocuments.noDocuments")}),e.jsx(k,{height:24})]}):null,e.jsxs(V,{visible:de,title:s("supportingDocuments.powerOfAttorneyModal.title"),icon:"document-regular",onPressClose:()=>N(!1),children:[e.jsx(T,{children:s("supportingDocuments.powerOfAttorneyModal.description")}),e.jsx(k,{height:16}),e.jsx(X,{paddingBottom:0,children:e.jsx(C,{grow:!0,color:"current",onPress:()=>window.open(`/power-of-attorney-template/${E(f).with("fr",()=>"fr").with("de",()=>"de").with("es",()=>"es").with("it",()=>"it").otherwise(()=>"en")}.pdf`),children:s("supportingDocuments.downloadTemplate")})})]}),e.jsxs(V,{visible:pe,title:s("supportingDocuments.purpose.SwornStatement"),icon:"document-regular",onPressClose:()=>M(!1),children:[e.jsx(T,{children:s("supportingDocuments.purpose.SwornStatement.description")}),e.jsx(k,{height:16}),e.jsx(X,{paddingBottom:0,children:e.jsx(C,{grow:!0,color:"current",onPress:()=>window.open("/sworn-statement-template/es.pdf"),children:s("supportingDocuments.downloadTemplate")})})]}),e.jsx(V,{visible:B(z),title:s("supportingDocuments.informations"),icon:"document-regular",onPressClose:()=>$(void 0),children:e.jsx(he,{children:z?.values.map(({title:t,value:u,type:g},D)=>e.jsx(Y,{type:"viewSmall",label:t,actions:g==="copy"&&e.jsx(Pe,{valueToCopy:u,copiedText:s("copyButton.copiedTooltip"),copyText:s("copyButton.copyTooltip")}),render:()=>e.jsx(T,{variant:"regular",color:we.gray[900],children:u})},`metadata-${D}`))})})]})};d.__docgenInfo={description:"",methods:[{name:"areAllRequiredDocumentsFilled",docblock:null,modifiers:[],params:[],returns:null},{name:"addDocument",docblock:null,modifiers:[],params:[{name:"document",optional:!1,type:null}],returns:null}],displayName:"SupportingDocumentCollection",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
...
//# sourceMappingURL=SupportingDocumentCollection.stories-BYPxSD2r.js.map
