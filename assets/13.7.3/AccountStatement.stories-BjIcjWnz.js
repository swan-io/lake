import{M as T,j as e,B as r,T as t,f as _,S as u,h as w,s as R,c as d,d as y,g as O}from"./ScrollView-Dv4JuB7b.js";import{u as x}from"./i18n-BszP3RtZ.js";import{g as s}from"./style-DpJi2vgq.js";import{S as D}from"./SwanLogo-B2eIHjK8.js";import{S as M,a as z}from"./_StoriesComponents-BSQJzXT1.js";import"./iframe-0msUamlX.js";import"./preload-helper-D1IIBeq1.js";import"./index-B6CJGp6o.js";import"./rifm-CWU0vYHM.js";import"./array-BfAlyugE.js";import"./Separator-0lCcnFD2.js";import"./commonStyles-BBEkV6IC.js";const n=R.create({container:{width:793,padding:10,fontFamily:"Inter, -apple-system, system-ui, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif"},firstSectionTitle:{...s("sans",20),color:d.swan[500],fontWeight:"500",textTransform:"uppercase",marginTop:"37px"},sectionTitle:{...s("sans",20),color:d.swan[500],fontWeight:"500",textTransform:"uppercase"},dateTitle:{...s("sans",12),color:d.swan[500]},totalAmount:{...s("sans",20),fontWeight:"500",textAlign:"right"},pageTitle:{...s("sans",20),fontWeight:"500",color:"#26232F"},titleColumn:{...s("sans",12),fontWeight:"600",paddingVertical:y[4],minWidth:y[96]},openingBalanceText:{...s("sans",12),textAlign:"right"},thead:{marginBottom:12,backgroundColor:d.gray[50]},textColumn:{paddingVertical:y[4],...s("sans",11),lineHeight:16},text:{...s("sans",12),color:d.swan[300]},textBold:{...s("sans",12),fontWeight:"500"},pageSubTitle:{...s("sans",12),color:"#454348"},row:{textAlign:"right",paddingVertical:y[4],fontWeight:"500",width:"15%"},closingBalanceRow:{...s("sans",12),backgroundColor:d.gray[50],width:"50%"},closingBalanceRowText:{paddingLeft:"20%"},dateContainer:{alignItems:"flex-start",flexDirection:"column"},dateText:{...s("sans",12),color:d.swan[500],letterSpacing:0,lineHeight:16},dateBold:{fontWeight:"600"}}),C=({text:i,align:a="left",style:l})=>e.jsx(t,{style:[n.titleColumn,l,{textAlign:a}],children:i}),G=(i,a)=>T(i).with("Card",()=>a("accountStatement.card")).with("Check",()=>a("accountStatement.check")).with("Fees",()=>a("accountStatement.fees")).with("InternationalDirectDebit","SepaDirectDebit",()=>a("accountStatement.directDebit")).with("SepaCreditTransfer","Seizure",()=>a("accountStatement.creditTransfer")).with("InternationalCreditTransfer",()=>a("accountStatement.internationalCreditTransfer")).otherwise(()=>i),E=({style:i,accountHolderName:a,accountHolderAddress:l,accountHolderType:m,iban:b,bic:h,openingDate:f,closingDate:j,openingBalance:A,transactions:I,feesDebit:F,feesCredit:H,totalsCredit:W,totalsDebit:L,closingBalance:N,language:P})=>{const o=x(P);return e.jsx(r,{style:i,children:e.jsx(r,{style:n.container,direction:"column",justifyContent:"spaceBetween",children:e.jsxs(r,{children:[e.jsxs(r,{direction:"row",justifyContent:"spaceBetween",children:[e.jsxs(r,{direction:"column",children:[e.jsx(t,{style:n.sectionTitle,children:a.toUpperCase()}),e.jsx(t,{style:n.text,children:l.street}),e.jsxs(t,{style:n.text,children:[l.city,","," ",_(l.country)&&l.country]}),e.jsx(u,{height:24}),w(b)&&e.jsxs(t,{style:n.textBold,children:[o("accountStatement.iban")," ",e.jsx(t,{style:n.text,children:b})]}),e.jsx(u,{height:4}),w(h)&&e.jsxs(t,{style:n.textBold,children:[o("accountStatement.bic")," ",e.jsx(t,{style:n.text,children:h})]})]}),e.jsxs(r,{direction:"column",alignItems:"end",children:[e.jsx(t,{style:n.pageTitle,children:o("accountStatement.titleDocument")}),e.jsx(t,{style:n.pageSubTitle,children:o(m==="Company"?"accountStatement.titleDocument.companyDescription":"accountStatement.titleDocument.individualDescription")}),e.jsx(u,{height:24}),e.jsx(t,{style:n.textBold,children:o("accountStatement.contactSupport")}),e.jsx(t,{style:n.text,children:"support.swan.io"})]})]}),e.jsx(u,{height:48}),e.jsxs(r,{direction:"row",justifyContent:"spaceBetween",alignItems:"center",children:[e.jsx(r,{style:n.dateContainer,children:e.jsxs(t,{style:n.dateText,children:[o("accountStatement.from")," ",e.jsx(t,{style:n.dateBold,children:f})," ",o("accountStatement.to")," ",e.jsx(t,{style:n.dateBold,children:j})]})}),e.jsxs(r,{direction:"column",children:[e.jsx(t,{style:n.openingBalanceText,children:o("accountStatement.openingBalance")}),e.jsx(t,{style:n.totalAmount,children:A.value})]})]}),e.jsx(u,{height:24}),e.jsxs(e.Fragment,{children:[e.jsxs(r,{direction:"row",style:n.thead,children:[e.jsx(t,{style:[n.titleColumn,{width:"13%"}],children:o("accountStatement.column.date")}),e.jsx(t,{style:[n.titleColumn,{width:"17%"}],children:o("accountStatement.column.type")}),e.jsx(t,{style:[n.titleColumn,{width:"40%"}],children:o("accountStatement.column.description")}),e.jsx(t,{style:[n.titleColumn,{width:"15%",textAlign:"right"}],children:o("accountStatement.column.credit")}),e.jsx(t,{style:[n.titleColumn,{width:"15%",textAlign:"right"}],children:o("accountStatement.column.debit")})]}),e.jsx(r,{direction:"column",children:I.map(p=>e.jsxs(r,{direction:"row",children:[e.jsx(t,{style:[n.textColumn,{width:"13%"}],children:p.date}),e.jsx(t,{style:[n.textColumn,{width:"17%"}],children:G(p.type,o)}),e.jsx(t,{style:[n.textColumn,{width:"40%"}],children:p.label}),e.jsx(t,{style:[n.textColumn,{width:"15%",textAlign:"right"}],children:p.credit?p.credit.value:""}),e.jsx(t,{style:[n.textColumn,{width:"15%",textAlign:"right"}],children:p.debit?p.debit.value:""})]},p.id))})]}),e.jsx(u,{height:12}),e.jsxs(r,{direction:"column",children:[e.jsxs(r,{direction:"row",justifyContent:"end",children:[e.jsx(t,{style:[n.row,n.textBold],children:o("accountStatement.column.fees")}),e.jsx(t,{style:[n.row,n.textBold],children:H.value}),e.jsx(t,{style:[n.row,n.textBold],children:F.value})]}),e.jsxs(r,{direction:"row",justifyContent:"end",children:[e.jsx(t,{style:[n.row,n.textBold],children:o("accountStatement.column.totals")}),e.jsx(t,{style:[n.row,n.textBold],children:W.value}),e.jsx(t,{style:[n.row,n.textBold],children:L.value})]})]}),e.jsx(u,{height:12}),e.jsx(r,{direction:"row",justifyContent:"end",children:e.jsxs(r,{direction:"row",alignItems:"center",style:n.closingBalanceRow,justifyContent:"spaceBetween",children:[e.jsx(C,{style:n.closingBalanceRowText,text:o("accountStatement.closingBalance")}),e.jsx(C,{text:N.value,style:n.totalAmount,align:"right"})]})})]})})})},U=i=>T(i).with({version:"v1"},a=>e.jsx(E,{...a})).exhaustive();E.__docgenInfo={description:"",methods:[],displayName:"AccountStatementV1",props:{version:{required:!0,tsType:{name:"literal",value:'"v1"'},description:""},style:{required:!1,tsType:{name:"StyleProp",elements:[{name:"ViewStyle"}],raw:"StyleProp<ViewStyle>"},description:""},accountHolderName:{required:!0,tsType:{name:"string"},description:""},accountHolderAddress:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  street: string;
  city: string;
  country?: CountryCCA3;
...
//# sourceMappingURL=AccountStatement.stories-BjIcjWnz.js.map
