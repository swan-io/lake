import{v as I,N as se,X as Ge,e as ae,u as Ke,s as Je,G as Qe,j as t,i as ee,$ as ue,S as x,L as K,c as Ye,o as Ze}from"./ScrollView-DWjQ00nM.js";import{r as l}from"./index-Cs7sjTYM.js";import{c as et}from"./commonStyles-t4XfA7cz.js";import{a as ge,L as N}from"./LakeButton-B6sbG4pD.js";import{L as tt}from"./LakeCopyButton-hk12aR6p.js";import{L as ye}from"./LakeLabel-BlQ3b0Ot.js";import{R as rt}from"./ReadOnlyFieldList-Df5kFVkW.js";import{t as m,l as nt,i as Ne}from"./i18n-CV4-0aDM.js";import{F as at}from"./FilesUploader-WDAH_diI.js";import{L as te}from"./LakeModal-DwHNW6FB.js";import{S as f,a as v}from"./_StoriesComponents-_jmnnGUR.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BU4L-DQy.js";import"./Pressable-CMe_F2_9.js";import"./index-BJ6ZNIxC.js";import"./extends-CF3RwP-h.js";import"./clipboard-BXAk6GqW.js";import"./v4-DvF23Exx.js";import"./rifm-CFTOlIhk.js";import"./utc-DJvBpWoA.js";import"./array-BfAlyugE.js";import"./FileInput-CbJ2q9s6.js";import"./LakeHeading-Devxa2jE.js";import"./useBoolean-DHW5baxv.js";import"./index-D3ylJrlI.js";import"./LakeAlert-B14skAKO.js";import"./useResponsive-CzIqCC5v.js";import"./Tag-CN2d3BfY.js";import"./index-CCMTQrND.js";import"./FocusTrap-BmeT9-In.js";import"./Suspendable-Di1_g3U1.js";import"./ResponsiveContainer-BdaVvCuB.js";import"./TransitionView-cETjUupd.js";import"./useBodyClassName-DMoYUPTW.js";function He(){try{var e=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch{}return(He=function(){return!!e})()}function ie(e,r){e.prototype=Object.create(r.prototype),e.prototype.constructor=e,H(e,r)}function oe(e){return oe=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(r){return r.__proto__||Object.getPrototypeOf(r)},oe(e)}function H(e,r){return H=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(n,a){return n.__proto__=a,n},H(e,r)}function X(e){var r=typeof Map=="function"?new Map:void 0;return X=function(n){if(n===null||!function(o){try{return Function.toString.call(o).indexOf("[native code]")!==-1}catch{return typeof o=="function"}}(n))return n;if(typeof n!="function")throw new TypeError("Super expression must either be null or a function");if(r!==void 0){if(r.has(n))return r.get(n);r.set(n,a)}function a(){return function(o,i,D){if(He())return Reflect.construct.apply(null,arguments);var k=[null];k.push.apply(k,i);var P=new(o.bind.apply(o,k));return D&&H(P,D.prototype),P}(n,arguments,oe(this).constructor)}return a.prototype=Object.create(n.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),H(a,n)},X(e)}function J(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}var ut=function(e){function r(n){var a;return(a=e.call(this,"Request to "+n+" failed")||this).url=void 0,Object.setPrototypeOf(J(a),r.prototype),a.name="NetworkError",a.url=n,a}return ie(r,e),r}(X(Error)),ot=function(e){function r(n,a){var o;return a==null?((o=e.call(this,"Request to "+n+" timed out")||this).url=void 0,o.timeout=void 0):((o=e.call(this,"Request to "+n+" timed out (> "+a+"ms)")||this).url=void 0,o.timeout=void 0),Object.setPrototypeOf(J(o),r.prototype),o.name="TimeoutError",o.url=n,o.timeout=a,J(o)}return ie(r,e),r}(X(Error)),st=function(e){function r(n,a,o){var i;return(i=e.call(this,"Request to "+n+" gave status "+a)||this).url=void 0,i.status=void 0,i.response=void 0,Object.setPrototypeOf(J(i),r.prototype),i.name="BadStatusError",i.url=n,i.status=a,i.response=o,i}return ie(r,e),r}(X(Error)),it=function(e){return e.ok?I.Ok(e):I.Error(new st(e.url,e.status,e.response.toUndefined()))},lt={make:function(e){var r=e.url,n=e.method,a=n===void 0?"GET":n,o=e.responseType,i=e.body,D=e.headers,k=e.withCredentials,P=k!==void 0&&k,q=e.onLoadStart,O=e.onProgress,U=e.timeout;return se.make(function(F){var s=new XMLHttpRequest;s.withCredentials=P,s.open(a,r,!0),o!=null&&(s.responseType=o),U!=null&&(s.timeout=U),D!=null&&Ge.entries(D).forEach(function(g){return s.setRequestHeader(g[0],g[1])});var z=function(){b(),F(I.Error(new ut(r)))},E=function(){b(),F(I.Error(new ot(r,U)))},j=function(){b();var g=s.status,Q=ae.fromNullable(s.response);F(I.Ok({url:r,status:g,ok:g>=200&&g<300,response:Q,xhr:s}))},b=function(){s.removeEventListener("error",z),s.removeEventListener("load",j),s.removeEventListener("timeout",E),q!=null&&s.removeEventListener("loadstart",q),O!=null&&s.removeEventListener("progress",O)};return s.addEventListener("error",z),s.addEventListener("load",j),s.addEventListener("timeout",E),q!=null&&s.addEventListener("loadstart",q),O!=null&&s.addEventListener("progress",O),s.send(i),function(){b(),s.abort()}})}};const le=l.memo(l.forwardRef(({style:e,onReset:r,onSubmit:n,...a},o)=>Ke("form",{...a,ref:o,onReset:i=>{i.preventDefault(),r==null||r(i)},onSubmit:i=>{i.preventDefault(),n==null||n(i)},style:[et.view,e]})));le.displayName="Form";le.__docgenInfo={description:"",methods:[],displayName:"Form"};const pt=["application/pdf","image/png","image/jpeg","image/heic"],re=Je.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:"default"}}),ne=e=>ue(e).with({type:"tooltip"},({text:r,width:n})=>t.jsx(Ze,{content:r,width:n,togglableOnFocus:!0,placement:"right",maxWidth:400,children:t.jsx(N,{mode:"tertiary",size:"small",color:"gray",icon:e.icon??"question-circle-regular",disabled:!0,style:[re.button,re.buttonWithDefaultCursor],ariaLabel:m("supportingDocuments.help.whatIsThis")})})).with({type:"button"},({label:r,onPress:n})=>t.jsx(N,{mode:"tertiary",size:"small",color:"gray",icon:e.icon??"question-circle-regular",onPress:n,style:re.button,ariaLabel:m("supportingDocuments.help.whatIsThis"),children:r})).exhaustive(),dt=e=>{const r=`supportingDocuments.purpose.${e}`;return Ne(r)?m(r):e},mt=e=>{const r=`supportingDocuments.purpose.${e}.description`;return Ne(r)?m(r):""},Xe=({documents:e,generateUpload:r,uploadFile:n,requiredDocumentPurposes:a,templateLanguage:o=nt.language,status:i,onRemoveFile:D,showIds:k=!1,readOnly:P=!1,getPurposeMetadata:q,readonlyDocumentPurposes:O=[]},U)=>{const[F,s]=l.useState(!1),[z,E]=l.useState(!1),[j,b]=l.useState(void 0),[g,Q]=l.useState([]),pe=l.useMemo(()=>{const u=new Set(a),c=[...g,...e];c.forEach(p=>u.add(p.purpose));const h=new Map([...u].map(p=>{const d=c.filter(S=>S.purpose===p);return[p,d]})),$=new Set(a),R=new Map([...u].map(p=>{const d=h.get(p)??[],G=d.length>0&&d.every(Y=>Y.file.statusInfo.status==="Validated")?0:$.has(p)?1:2;return[p,G]}));return[...u].sort((p,d)=>{const S=R.get(p)??2;return(R.get(d)??2)>S?-1:1}).map(p=>{const d=h.get(p)??[];return{purpose:p,files:d.map(S=>S.file),isRequired:$.has(p),areAllDocumentsValidated:R.get(p)===0}})},[a,e,g]),de=l.useRef(new Map(Qe.filterMap(pe,({isRequired:u,purpose:c,files:h})=>u?ae.Some([c,h]):ae.None()))),me=l.useRef({});l.useImperativeHandle(U,()=>({areAllRequiredDocumentsFilled:()=>[...de.current.values()].every(c=>c.length>0),addDocument:u=>{Q(c=>[...c,u])}})),l.useEffect(()=>{const u=g[g.length-1];if(u!=null){const c=me.current[u==null?void 0:u.purpose];c!=null&&c.add(u.file)}},[g]);const ce=pe.filter(({files:u})=>!(P&&u.length===0));return t.jsxs(le,{children:[ce.map(({purpose:u,files:c,areAllDocumentsValidated:h,isRequired:$})=>{const R=q==null?void 0:q(u),p=mt(u);return t.jsxs(l.Fragment,{children:[t.jsx(ye,{label:dt(u),description:p,help:ee(R)?t.jsx(ne,{type:"button",label:R.title,onPress:()=>b(R)}):ue(u).with("PowerOfAttorney",()=>t.jsx(ne,{type:"button",icon:"arrow-down-filled",label:m("supportingDocuments.help.downloadTemplate"),onPress:()=>s(!0)})).with("SwornStatement",()=>t.jsx(ne,{type:"button",icon:"arrow-down-filled",label:m("supportingDocuments.help.downloadTemplate"),onPress:()=>E(!0)})).otherwise(()=>null),render:()=>t.jsx(at,{ref:d=>me.current[u]=d,canUpload:!O.includes(u)&&!P&&i==="WaitingForDocument"&&!h,accept:pt,maxSize:2e7,icon:"document-regular",initialFiles:c,generateUpload:r,getUploadConfig:d=>({fileName:d.name,purpose:u}),uploadFile:ee(n)?n:({upload:d,file:S,onLoadStart:G,onProgress:Y})=>{const Z=new FormData;return d.fields.forEach(({key:ze,value:$e})=>Z.append(ze,$e)),Z.append("file",S),lt.make({url:d.url,method:"POST",onLoadStart:G,onProgress:Y,body:Z}).mapOkToResult(it)},formatAndSizeDescription:m("supportingDocuments.documentTypes",{maxSizeMB:2e7/1e6}),onRemoveFile:P?void 0:D,onChange:d=>{$&&de.current.set(u,d)},showIds:k})}),t.jsx(x,{height:24})]},u)}),ce.length===0?t.jsxs(t.Fragment,{children:[t.jsx(x,{height:24}),t.jsx(K,{align:"center",children:m("supportingDocuments.noDocuments")}),t.jsx(x,{height:24})]}):null,t.jsxs(te,{visible:F,title:m("supportingDocuments.powerOfAttorneyModal.title"),icon:"document-regular",onPressClose:()=>s(!1),children:[t.jsx(K,{children:m("supportingDocuments.powerOfAttorneyModal.description")}),t.jsx(x,{height:16}),t.jsx(ge,{paddingBottom:0,children:t.jsx(N,{grow:!0,color:"current",onPress:()=>window.open(`/power-of-attorney-template/${ue(o).with("fr",()=>"fr").with("de",()=>"de").with("es",()=>"es").otherwise(()=>"en")}.pdf`),children:m("supportingDocuments.downloadTemplate")})})]}),t.jsxs(te,{visible:z,title:m("supportingDocuments.purpose.SwornStatement"),icon:"document-regular",onPressClose:()=>E(!1),children:[t.jsx(K,{children:m("supportingDocuments.purpose.SwornStatement.description")}),t.jsx(x,{height:16}),t.jsx(ge,{paddingBottom:0,children:t.jsx(N,{grow:!0,color:"current",onPress:()=>window.open("/sworn-statement-template/es.pdf"),children:m("supportingDocuments.downloadTemplate")})})]}),t.jsx(te,{visible:ee(j),title:m("supportingDocuments.informations"),icon:"document-regular",onPressClose:()=>b(void 0),children:t.jsx(rt,{children:j==null?void 0:j.values.map(({title:u,value:c,type:h})=>t.jsx(ye,{type:"viewSmall",label:u,actions:h==="copy"&&t.jsx(tt,{valueToCopy:c,copiedText:m("copyButton.copiedTooltip"),copyText:m("copyButton.copyTooltip")}),render:()=>t.jsx(K,{variant:"regular",color:Ye.gray[900],children:c})}))})})]})},y=l.forwardRef(Xe);Xe.__docgenInfo={description:"",methods:[{name:"areAllRequiredDocumentsFilled",docblock:null,modifiers:[],params:[],returns:null},{name:"addDocument",docblock:null,modifiers:[],params:[{name:"document",optional:!1,type:null}],returns:null}],displayName:"SupportingDocumentCollectionWithRef",props:{status:{required:!0,tsType:{name:"union",raw:`| "WaitingForDocument"
| "PendingReview"
| "Approved"
| "Canceled"
