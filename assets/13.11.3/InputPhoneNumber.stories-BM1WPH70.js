import{j as e,B,S,L as I,c as C,h as L,s as w,V as D}from"./ScrollView-BFTe3NUs.js";import{a as A}from"./LakeButton-DaCk3atp.js";import{L as E}from"./LakeLabel-DUDCfYb7.js";import{u as W}from"./index-CJxYDZJf.js";import{L as _}from"./LakeTextInput-ehHiMKp1.js";import{r as k}from"./iframe-DgAaViVc.js";import{p as O,b as N}from"./countries-BkcXMwYK.js";import{P as z}from"./PhoneCountryPicker-Br3MYB2S.js";import{S as G,a as t}from"./_StoriesComponents-BnU3qKiC.js";import"./index-BAAQiwsw.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-Cyr_eKr3.js";import"./index-LA1RMurX.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-Cy3BXFsl.js";import"./LakeSelect-C8AnzRU7.js";import"./i18n-Ci6qpPDI.js";import"./array-BfAlyugE.js";import"./useBoolean-D58j8Sx5.js";import"./useDisclosure-Gc9hAebV.js";import"./FocusTrap-3fW7XPjR.js";import"./FlatList-fU5uFXlh.js";import"./Popover-C-t6NXu2.js";import"./useResponsive-COoCDTYK.js";import"./function-VwuJLJSp.js";import"./BottomPanel-i_n2HwFS.js";import"./useBodyClassName-BLP68U00.js";import"./Suspendable-jY3Y2eU_.js";import"./TransitionView-j0JnRKln.js";import"./index-ByBJbYnQ.js";import"./Separator-OzvEz0ZT.js";import"./preload-helper-D1IIBeq1.js";import"./string-DUDiXCY5.js";import"./Flag-dKSIIQhH.js";const j=w.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:c,id:d,country:m,value:p,countries:y,error:a,help:g,valid:f=!1,autofocus:r=!1,disabled:n=!1,readOnly:o=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:P,onSubmitEditing:s,onBlur:T})=>{const u=k.useRef(null),R=x=>{const F=x.replace(/[^ +0-9-()]/g,"");x===F&&P(x)};k.useEffect(()=>{r&&u.current&&setTimeout(()=>u.current?.focus(),250)},[r,m]),k.useImperativeHandle(c,()=>({focus:()=>u.current?.focus(),blur:()=>u.current?.blur()}),[]);const V=[j.picker,(n||o)&&j.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:m,countries:y??O,onValueChange:v,disabled:n,readOnly:o,error:a,ariaLabel:b,style:V}),e.jsx(_,{id:d,ref:u,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:p,valid:f,error:a,disabled:n,readOnly:o,onChangeText:R,onSubmitEditing:s,onBlur:T,style:j.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(S,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(a)?C.negative[500]:C.gray[500],children:a??g??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-BM1WPH70.js.map
