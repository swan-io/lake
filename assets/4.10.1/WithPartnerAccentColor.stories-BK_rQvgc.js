import{s as p,a as o,c as t,V as d}from"./Space-0QEd5EJK.js";import{B as h}from"./commonStyles-jyCP8gIs.js";import{W as l}from"./WithPartnerAccentColor-DO4wAqjX.js";import{S as m}from"./_StoriesComponents-C7kheqYo.js";import"./extends-CCbyfPlC.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CBqU2yxZ.js";import"./index-BtM5VmRH.js";import"./polished.esm-1TDmsf3v.js";const n=p.create({container:{flexWrap:"wrap"},colorBlock:{width:60,height:40,margin:8,borderRadius:4}}),W={title:"Utilities/WithPartnerAccentColor",component:l},r=({color:i="black"})=>o(m,{title:"WithPartnerAccentColor",description:["This component generate from a color palette with different shades and change the color of all its children using 'colors.partner[shade]'","You can edit the color in 'Controls' panel. (Press A to open it)"],children:o(l,{color:i,children:o(h,{direction:"row",style:n.container,children:Object.keys(t.partner).map(e=>o(d,{style:[n.colorBlock,{backgroundColor:t.partner[e]}]},e))})})});var c,a,s;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`({
  color = "black"
}: StoryArgs) => {
...
//# sourceMappingURL=WithPartnerAccentColor.stories-BK_rQvgc.js.map
