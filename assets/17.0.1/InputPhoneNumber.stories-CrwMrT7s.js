import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-BEfGCJNn.js";import{$ as r,G as i,J as a,Pt as o,Tt as s,_t as c,g as l,h as u,i as d,mt as f,o as p,r as m,s as h,zt as g}from"./ScrollView-Bti_909s.js";import{r as _,t as v}from"./LakeButton-D1ZZ0wPa.js";import{n as y,t as b}from"./LakeTextInput-4oYkv4I4.js";import{n as x,t as S}from"./LakeLabel-ByuFRcyc.js";import{n as C,r as w,t as T}from"./_StoriesComponents-zSoat3Ga.js";import{c as E,o as D,u as O}from"./countries-Bv16Qx3s.js";import{n as k,t as A}from"./dist-BkYXpqbi.js";import{n as j,t as M}from"./PhoneCountryPicker-Cmyq_WFT.js";var N,P,F,I,L=t((()=>{l(),h(),y(),d(),c(),i(),N=e(n()),s(),E(),j(),P=r(),F=g.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:f.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),I=({ref:e,id:t,country:n,value:r,countries:i,error:o,help:s,valid:c=!1,autofocus:l=!1,disabled:d=!1,readOnly:h=!1,countryAriaLabel:g,hideErrors:_=!1,onCountryChange:v,onChangeText:y,onSubmitEditing:x,onBlur:S})=>{let C=(0,N.useRef)(null),w=e=>{e===e.replace(/[^ +0-9-()]/g,``)&&y(e)};(0,N.useEffect)(()=>{l&&C.current&&setTimeout(()=>C.current?.focus(),250)},[l,n]),(0,N.useImperativeHandle)(e,()=>({focus:()=>C.current?.focus(),blur:()=>C.current?.blur()}),[]);let T=[F.picker,(d||h)&&F.pickerDisabled];return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(u,{direction:`row`,children:[(0,P.jsx)(M,{value:n,countries:i??O,onValueChange:v,disabled:d,readOnly:h,error:o,ariaLabel:g,style:T}),(0,P.jsx)(b,{id:t,ref:C,autoComplete:`tel`,inputMode:`tel`,rows:1,hideErrors:!0,value:r,valid:c,error:o,disabled:d,readOnly:h,onChangeText:w,onSubmitEditing:x,onBlur:S,style:F.input})]}),!_&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(m,{height:4}),(0,P.jsx)(p,{variant:`smallRegular`,color:a(o)?f.negative[500]:f.gray[500],children:o??s??` `})]})]})},I.__docgenInfo={description:``,methods:[{name:`focus`,docblock:null,modifiers:[],params:[],returns:null},{name:`blur`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`InputPhoneNumber`,props:{ref:{required:!1,tsType:{name:`Ref`,elements:[{name:`signature`,type:`object`,raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-CrwMrT7s.js.map