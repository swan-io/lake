import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-BEfGCJNn.js";import{$ as r,Ct as i,G as a,Pt as o,Tt as s,Y as c,_ as l,_t as u,ft as d,g as f,h as p,i as m,mt as h,n as g,pt as ee,q as _,r as v,t as te,v as y,zt as b}from"./ScrollView-Bti_909s.js";import{n as x,t as S}from"./commonStyles-IchN61IH.js";import{r as C,t as w}from"./LakeButton-D1ZZ0wPa.js";import{n as T,t as E}from"./Tag-B1__3j9Y.js";import{r as D,t as O}from"./dist-DyNf1Ant.js";import{n as k,r as A}from"./LakeCheckbox-D2SH8lvp.js";import{n as j,t as ne}from"./LakeHeading-BQT93XoF.js";import{n as M,t as re}from"./ResponsiveContainer-7XKvVWbs.js";import{a as N,c as P,n as F,r as I,s as L}from"./VirtualizedList-DaAXcRhs.js";var R,z,B,V,H,U,W,G,ie=t((()=>{R=e(n()),s(),x(),u(),l(),a(),j(),M(),g(),I(),z=r(),B=b.create({root:{height:1,alignSelf:`stretch`,flexGrow:1,backgroundColor:d.default},contentContainer:{flexDirection:`column`,alignItems:`stretch`,flexGrow:1},segment:{flexDirection:`row`,alignItems:`stretch`,overflow:`hidden`,paddingHorizontal:i[16]},segmentLarge:{paddingHorizontal:i[32]},row:{boxShadow:`inset 0 -1px ${h.gray[100]}`},activeRow:{backgroundColor:d.accented},hoveredRow:{backgroundColor:d.accented},segmentHeaderCell:{display:`flex`,flexDirection:`row`,alignItems:`center`},header:{position:`sticky`,top:0,flexDirection:`row`,alignItems:`stretch`,zIndex:2},stickyHeader:{position:`sticky`,backgroundColor:d.default90Transparency,backdropFilter:`blur(4px)`,zIndex:10,paddingHorizontal:i[24],flexDirection:`row`,alignItems:`center`},stickyHeaderLarge:{paddingHorizontal:i[40]},loadingPlaceholder:{position:`absolute`,left:0,right:0,top:0},rowLink:{color:`inherit`,textDecorationLine:`none`},emptyListContainer:{...S.fill,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:i[48],backgroundColor:d.default},scrollTracker:{pointerEvents:`none`,position:`absolute`,left:0,bottom:0,right:0}}),V=1,H=0,U=({id:e,item:t,index:n,rowHeight:r,columns:i,extraInfo:a,isActive:s,isHovered:c,large:l,style:u,onMouseEnter:d,onMouseLeave:f})=>{let p=(0,R.useRef)(null);return y(p,{onHoverStart:()=>d(e),onHoverEnd:()=>f()}),(0,z.jsx)(o,{ref:p,role:`row`,style:[B.segment,l&&B.segmentLarge,B.row,u?.(t,l),s&&B.activeRow,c&&B.hoveredRow,{minHeight:r}],children:i.map(({width:e,id:r,renderCell:i})=>(0,z.jsx)(o,{style:[B.segmentHeaderCell,{width:typeof e==`number`?e:V,flexGrow:e===`grow`?V:H}],id:r,children:i({columnId:r,item:t,index:n,extraInfo:a,isHovered:c})},r))})},W=({data:e,keyExtractor:t,rowHeight:n,groupHeaderHeight:r,headerHeight:i,columns:a,smallColumns:s=a,extraInfo:l,onEndReached:u,onEndReachedThresholdPx:f=200,headerStyle:p,rowStyle:m,getRowLink:h,activeRowId:g,renderEmptyList:v,onActiveRowChange:y,groupBy:b,loading:x,breakpoint:C=ee.large,withoutScroll:w=!1,stickyOffset:T=0,headerBackgroundColor:E=d.default})=>{let D=(0,R.useId)(),O=(0,R.useRef)(null),k=(0,R.useMemo)(()=>{if(b==null)return new Map([[null,e]]);let t=new Map;return e.forEach(e=>{let n=b(e);t.set(n,[...t.get(n)??[],e])}),t},[b,e]),A=n*e.length+k.size*r,j=_(x)&&x.isLoading,M=e.length===0,[N,P]=(0,R.useState)(void 0),F=(0,R.useCallback)(()=>{P(void 0)},[]);(0,R.useEffect)(()=>{let e=O.current;if(e!=null){let t=e,n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&_(u)&&u()})});return n.observe(t),()=>n.unobserve(t)}},[u]);let I=(0,R.useCallback)(({item:e,absoluteIndex:t,extraInfo:n})=>{let r=h?.({item:e,index:t,extraInfo:n});return c(r)?(0,z.jsx)(o,{}):r},[h]),L=(0,R.useRef)(null);(0,R.useEffect)(()=>{let e=L.current;if(g!=null&&e!=null){let t=e;t.scrollIntoView({behavior:`smooth`,block:`nearest`}),y?.(t)}},[g,y]);let W=(0,R.useMemo)(()=>w?(0,z.jsx)(o,{style:B.contentContainer}):(0,z.jsx)(te,{scrollEventThrottle:32,contentContainerStyle:[B.contentContainer,{minHeight:A+(j?x.count*n:0)}]}),[j,x?.count,n,A,w]);return(0,z.jsx)(re,{role:`table`,style:w?M?S.fill:void 0:B.root,breakpoint:C,children:({large:e})=>{let c=e?a:s;return(0,z.jsx)(z.Fragment,{children:(0,R.cloneElement)(W,{children:(0,z.jsxs)(z.Fragment,{children:[!M&&e?(0,z.jsx)(o,{role:`row`,style:[B.segment,B.segmentLarge,B.header,p,{backgroundColor:E}],children:c.map(({id:e,width:t,title:n,renderTitle:r})=>{let a=`${D}_${e}`;return(0,z.jsx)(o,{style:[B.segmentHeaderCell,{width:typeof t==`number`?t:V,flexGrow:t===`grow`?V:H,height:i}],id:a,children:r({title:n,extraInfo:l,id:e})},a)})}):null,(0,z.jsx)(o,{children:Array.from(k.entries()).map(([a,s])=>(0,z.jsxs)(R.Fragment,{children:[a==null?null:(0,z.jsx)(o,{style:[B.stickyHeader,e&&B.stickyHeaderLarge,{height:r,paddingTop:r/4,top:T+(e?i:0)}],children:(0,z.jsx)(ne,{level:`none`,variant:`h3`,children:a})}),s.map((r,i)=>{let a=t(r,i),o=g===a,s=_(h)&&N===a,u=I({item:r,absoluteIndex:i,extraInfo:l});return(0,R.cloneElement)(u,{style:{...B.rowLink,...u.props.style},key:i,ref:o?L:null,children:(0,z.jsx)(U,{id:a,rowHeight:n,columns:c,item:r,index:i,extraInfo:l,isActive:o,isHovered:s,large:e,style:m,onMouseEnter:P,onMouseLeave:F})})})]},a))}),(0,z.jsx)(o,{children:(0,z.jsx)(o,{"aria-busy":j,style:B.loadingPlaceholder,children:j?(0,z.jsx)(G,{count:x.count,rowHeight:n}):null})}),M&&_(v)&&!j?(0,z.jsx)(o,{style:B.emptyListContainer,children:v()}):null,(0,z.jsx)(o,{style:[B.scrollTracker,{height:f}],ref:O})]})})})}})},G=F,W.__docgenInfo={description:``,methods:[],displayName:`PlainListView`,props:{data:{required:!0,tsType:{name:`Array`,elements:[{name:`T`}],raw:`T[]`},description:``},keyExtractor:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(item: T, index: number) => string`,signature:{arguments:[{type:{name:`T`},name:`item`},{type:{name:`number`},name:`index`}],return:{name:`string`}}},description:``},highlightedRowId:{required:!1,tsType:{name:`string`},description:``},headerHeight:{required:!0,tsType:{name:`number`},description:``},rowHeight:{required:!0,tsType:{name:`number`},description:``},groupHeaderHeight:{required:!0,tsType:{name:`number`},description:``},extraInfo:{required:!0,tsType:{name:`ExtraInfo`},description:``},columns:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
}`,...$.parameters?.docs?.source}}},ae=[`Primary`,`MultiColumn`]}))();export{$ as MultiColumn,Q as Primary,ae as __namedExportsOrder,J as default};
//# sourceMappingURL=PlainListView.stories-DVJxtNWL.js.map