import{i as A,j as e,f as fe,V as m,s as be,h as pe,o as he,b as v,a as j,c as Ne,u as ye,B as xe,S as B}from"./ScrollView-DV2HYh1s.js";import{r as n}from"./iframe-B-8A2VXd.js";import{V as Te,T as y,H as x}from"./VirtualizedList-CrTAaRW5.js";import{L as W}from"./LakeButton-DQhUE3xl.js";import{a as we}from"./LakeCheckbox-CxOkPDeV.js";import{c as ie}from"./commonStyles-BBEkV6IC.js";import{L as Ce}from"./LakeHeading-DGeAftUV.js";import{R as Ie}from"./ResponsiveContainer-Ce062vJE.js";import{T as ke}from"./Tag-DJEQmtWi.js";import{v as Me}from"./v4-C6aID195.js";import"./index-NeHMD_S9.js";import"./preload-helper-DrfBMU97.js";import"./Pressable-C2thV3S3.js";import"./index-BYCuiJSt.js";import"./extends-CF3RwP-h.js";import"./index-DZ-7AQtC.js";const Se="inherit",r=be.create({root:{height:1,alignSelf:"stretch",flexGrow:1,backgroundColor:v.default},contentContainer:{flexDirection:"column",alignItems:"stretch",flexGrow:1},segment:{flexDirection:"row",alignItems:"stretch",overflow:"hidden",paddingHorizontal:j[16]},segmentLarge:{paddingHorizontal:j[32]},row:{boxShadow:`inset 0 -1px ${Ne.gray[100]}`},activeRow:{backgroundColor:v.accented},hoveredRow:{backgroundColor:v.accented},segmentHeaderCell:{display:"flex",flexDirection:"row",alignItems:"center"},header:{position:"sticky",top:0,flexDirection:"row",alignItems:"stretch",zIndex:2},stickyHeader:{position:"sticky",backgroundColor:v.default90Transparency,backdropFilter:"blur(4px)",zIndex:10,paddingHorizontal:j[24],flexDirection:"row",alignItems:"center"},stickyHeaderLarge:{paddingHorizontal:j[40]},loadingPlaceholder:{position:"absolute",left:0,right:0,top:0},rowLink:{color:Se,textDecorationLine:"none"},emptyListContainer:{...ie.fill,flexDirection:"column",alignItems:"center",justifyContent:"center",padding:j[48],backgroundColor:v.default},scrollTracker:{pointerEvents:"none",position:"absolute",left:0,bottom:0,right:0}}),K=1,te=0,ve=({id:t,item:p,index:a,rowHeight:T,columns:h,extraInfo:I,isActive:k,isHovered:f,large:N,style:b,onMouseEnter:E,onMouseLeave:R})=>{const g=n.useRef(null);return ye(g,{onHoverStart:()=>E(t),onHoverEnd:()=>R()}),e.jsx(m,{ref:g,style:[r.segment,N&&r.segmentLarge,r.row,b==null?void 0:b(p,N),k&&r.activeRow,f&&r.hoveredRow,{minHeight:T}],children:h.map(({width:i,id:d,renderCell:c})=>e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof i=="number"?i:K,flexGrow:i==="grow"?K:te}],id:d,children:c({columnId:d,item:p,index:a,extraInfo:I,isHovered:f})},d))})},q=({data:t,keyExtractor:p,rowHeight:a,groupHeaderHeight:T,headerHeight:h,columns:I,smallColumns:k=I,extraInfo:f,onEndReached:N,onEndReachedThresholdPx:b=200,headerStyle:E,rowStyle:R,getRowLink:g,activeRowId:i,renderEmptyList:d,onActiveRowChange:c,groupBy:F,loading:w,breakpoint:re=he.large,withoutScroll:D=!1,stickyOffset:le=0,headerBackgroundColor:de=v.default})=>{const se=n.useId(),O=n.useRef(null),J=n.useMemo(()=>{if(F==null)return new Map([[null,t]]);const l=new Map;return t.forEach(o=>{const s=F(o);l.set(s,[...l.get(s)??[],o])}),l},[F,t]),Q=a*t.length+J.size*T,H=A(w)&&w.isLoading,G=t.length===0,[oe,Z]=n.useState(void 0),me=n.useCallback(()=>{Z(void 0)},[]);n.useEffect(()=>{const l=O.current;if(l!=null){const o=l,s=new IntersectionObserver(u=>{u.forEach(C=>{C.isIntersecting&&A(N)&&N()})});return s.observe(o),()=>s.unobserve(o)}},[N]);const ge=n.useCallback(({item:l,absoluteIndex:o,extraInfo:s})=>{const u=g==null?void 0:g({item:l,index:o,extraInfo:s});return fe(u)?e.jsx(m,{}):u},[g]),Y=n.useRef(null);n.useEffect(()=>{const l=Y.current;if(i!=null&&l!=null){const o=l;o.scrollIntoView({behavior:"smooth",block:"nearest"}),c==null||c(o)}},[i,c]);const ce=n.useMemo(()=>D?e.jsx(m,{style:r.contentContainer}):e.jsx(pe,{scrollEventThrottle:32,contentContainerStyle:[r.contentContainer,{minHeight:Q+(H?w.count*a:0)}]}),[H,w==null?void 0:w.count,a,Q,D]);return e.jsx(Ie,{style:D?G?ie.fill:void 0:r.root,breakpoint:re,children:({large:l})=>{const o=l?I:k;return e.jsx(e.Fragment,{children:n.cloneElement(ce,{children:e.jsxs(e.Fragment,{children:[!G&&l?e.jsx(m,{style:[r.segment,r.segmentLarge,r.header,E,{backgroundColor:de}],children:o.map(({id:s,width:u,title:C,renderTitle:M})=>{const S=`${se}_${s}`;return e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof u=="number"?u:K,flexGrow:u==="grow"?K:te,height:h}],id:S,children:M({title:C,extraInfo:f,id:s})},S)})}):null,e.jsx(m,{children:Array.from(J.entries()).map(([s,u])=>e.jsxs(n.Fragment,{children:[s!=null?e.jsx(m,{style:[r.stickyHeader,l&&r.stickyHeaderLarge,{height:T,paddingTop:T/4,top:le+(l?h:0)}],children:e.jsx(Ce,{level:3,variant:"h3",children:s})}):null,u.map((C,M)=>{const S=p(C,M),X=i===S,ue=A(g)&&oe===S,U=ge({item:C,absoluteIndex:M,extraInfo:f});return n.cloneElement(U,{style:{...r.rowLink,...U.props.style},key:M,ref:X?Y:null,children:e.jsx(ve,{id:S,rowHeight:a,columns:o,item:C,index:M,extraInfo:f,isActive:X,isHovered:ue,large:l,style:R,onMouseEnter:Z,onMouseLeave:me})})})]},s))}),e.jsx(m,{children:e.jsx(m,{"aria-busy":H,style:r.loadingPlaceholder,children:H?e.jsx(Ee,{count:w.count,rowHeight:a}):null})}),G&&A(d)&&!H?e.jsx(m,{style:r.emptyListContainer,children:d()}):null,e.jsx(m,{style:[r.scrollTracker,{height:b}],ref:O})]})})})}})},Ee=Te;q.__docgenInfo={description:"",methods:[],displayName:"PlainListView",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},keyExtractor:{required:!0,tsType:{name:"signature",type:"function",raw:"(item: T, index: number) => string",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"string"}}},description:""},highlightedRowId:{required:!1,tsType:{name:"string"},description:""},headerHeight:{required:!0,tsType:{name:"number"},description:""},rowHeight:{required:!0,tsType:{name:"number"},description:""},groupHeaderHeight:{required:!0,tsType:{name:"number"},description:""},extraInfo:{required:!0,tsType:{name:"ExtraInfo"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
}`,...(ne=(ae=P.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};const Ue=["Primary","MultiColumn"];export{P as MultiColumn,L as Primary,Ue as __namedExportsOrder,Xe as default};
//# sourceMappingURL=PlainListView.stories-jB0soTsD.js.map
