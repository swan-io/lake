import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-xecgKmXw.js";import{Bt as r,Et as i,Ft as a,J as o,K as s,X as c,_ as l,et as u,g as d,h as f,ht as p,i as m,mt as ee,n as h,pt as g,r as _,t as te,v,vt as y,wt as b}from"./ScrollView-CIA5lAtq.js";import{n as x,t as S}from"./commonStyles-IchN61IH.js";import{r as C,t as w}from"./LakeButton-nkf7TWs4.js";import{n as T,t as E}from"./Tag-DL0EqmqT.js";import{r as D,t as O}from"./dist-DyNf1Ant.js";import{n as k,r as A}from"./LakeCheckbox-CIlvC9uQ.js";import{n as j,t as ne}from"./LakeHeading-AhEAt0i9.js";import{n as M,t as re}from"./ResponsiveContainer-fLl4W2di.js";import{a as N,c as P,n as F,r as I,s as L}from"./VirtualizedList-C6DaU5Bt.js";var R,z,B,V,H,U,W,G,ie=t((()=>{R=e(n()),i(),x(),y(),l(),s(),j(),M(),h(),I(),z=u(),B=r.create({root:{height:1,alignSelf:`stretch`,flexGrow:1,backgroundColor:g.default},contentContainer:{flexDirection:`column`,alignItems:`stretch`,flexGrow:1},segment:{flexDirection:`row`,alignItems:`stretch`,overflow:`hidden`,paddingHorizontal:b[16]},segmentLarge:{paddingHorizontal:b[32]},row:{boxShadow:`inset 0 -1px ${p.gray[100]}`},activeRow:{backgroundColor:g.accented},hoveredRow:{backgroundColor:g.accented},segmentHeaderCell:{display:`flex`,flexDirection:`row`,alignItems:`center`},header:{position:`sticky`,top:0,flexDirection:`row`,alignItems:`stretch`,zIndex:2},stickyHeader:{position:`sticky`,backgroundColor:g.default90Transparency,backdropFilter:`blur(4px)`,zIndex:10,paddingHorizontal:b[24],flexDirection:`row`,alignItems:`center`},stickyHeaderLarge:{paddingHorizontal:b[40]},loadingPlaceholder:{position:`absolute`,left:0,right:0,top:0},rowLink:{color:`inherit`,textDecorationLine:`none`},emptyListContainer:{...S.fill,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:b[48],backgroundColor:g.default},scrollTracker:{pointerEvents:`none`,position:`absolute`,left:0,bottom:0,right:0}}),V=1,H=0,U=({id:e,item:t,index:n,rowHeight:r,columns:i,extraInfo:o,isActive:s,isHovered:c,large:l,style:u,onMouseEnter:d,onMouseLeave:f})=>{let p=(0,R.useRef)(null);return v(p,{onHoverStart:()=>d(e),onHoverEnd:()=>f()}),(0,z.jsx)(a,{ref:p,role:`row`,style:[B.segment,l&&B.segmentLarge,B.row,u?.(t,l),s&&B.activeRow,c&&B.hoveredRow,{minHeight:r}],children:i.map(({width:e,id:r,renderCell:i})=>(0,z.jsx)(a,{style:[B.segmentHeaderCell,{width:typeof e==`number`?e:V,flexGrow:e===`grow`?V:H}],id:r,children:i({columnId:r,item:t,index:n,extraInfo:o,isHovered:c})},r))})},W=({data:e,keyExtractor:t,rowHeight:n,groupHeaderHeight:r,headerHeight:i,columns:s,smallColumns:l=s,extraInfo:u,onEndReached:d,onEndReachedThresholdPx:f=200,headerStyle:p,rowStyle:m,getRowLink:h,activeRowId:_,renderEmptyList:v,onActiveRowChange:y,groupBy:b,loading:x,breakpoint:C=ee.large,withoutScroll:w=!1,stickyOffset:T=0,headerBackgroundColor:E=g.default})=>{let D=(0,R.useId)(),O=(0,R.useRef)(null),k=(0,R.useMemo)(()=>{if(b==null)return new Map([[null,e]]);let t=new Map;return e.forEach(e=>{let n=b(e);t.set(n,[...t.get(n)??[],e])}),t},[b,e]),A=n*e.length+k.size*r,j=o(x)&&x.isLoading,M=e.length===0,[N,P]=(0,R.useState)(void 0),F=(0,R.useCallback)(()=>{P(void 0)},[]);(0,R.useEffect)(()=>{let e=O.current;if(e!=null){let t=e,n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&o(d)&&d()})});return n.observe(t),()=>n.unobserve(t)}},[d]);let I=(0,R.useCallback)(({item:e,absoluteIndex:t,extraInfo:n})=>{let r=h?.({item:e,index:t,extraInfo:n});return c(r)?(0,z.jsx)(a,{}):r},[h]),L=(0,R.useRef)(null);(0,R.useEffect)(()=>{let e=L.current;if(_!=null&&e!=null){let t=e;t.scrollIntoView({behavior:`smooth`,block:`nearest`}),y?.(t)}},[_,y]);let W=(0,R.useMemo)(()=>w?(0,z.jsx)(a,{style:B.contentContainer}):(0,z.jsx)(te,{scrollEventThrottle:32,contentContainerStyle:[B.contentContainer,{minHeight:A+(j?x.count*n:0)}]}),[j,x?.count,n,A,w]);return(0,z.jsx)(re,{role:`table`,style:w?M?S.fill:void 0:B.root,breakpoint:C,children:({large:e})=>{let c=e?s:l;return(0,z.jsx)(z.Fragment,{children:(0,R.cloneElement)(W,{children:(0,z.jsxs)(z.Fragment,{children:[!M&&e?(0,z.jsx)(a,{role:`row`,style:[B.segment,B.segmentLarge,B.header,p,{backgroundColor:E}],children:c.map(({id:e,width:t,title:n,renderTitle:r})=>{let o=`${D}_${e}`;return(0,z.jsx)(a,{style:[B.segmentHeaderCell,{width:typeof t==`number`?t:V,flexGrow:t===`grow`?V:H,height:i}],id:o,children:r({title:n,extraInfo:u,id:e})},o)})}):null,(0,z.jsx)(a,{children:Array.from(k.entries()).map(([s,l])=>(0,z.jsxs)(R.Fragment,{children:[s==null?null:(0,z.jsx)(a,{style:[B.stickyHeader,e&&B.stickyHeaderLarge,{height:r,paddingTop:r/4,top:T+(e?i:0)}],children:(0,z.jsx)(ne,{level:`none`,variant:`h3`,children:s})}),l.map((r,i)=>{let a=t(r,i),s=_===a,l=o(h)&&N===a,d=I({item:r,absoluteIndex:i,extraInfo:u});return(0,R.cloneElement)(d,{style:{...B.rowLink,...d.props.style},key:i,ref:s?L:null,children:(0,z.jsx)(U,{id:a,rowHeight:n,columns:c,item:r,index:i,extraInfo:u,isActive:s,isHovered:l,large:e,style:m,onMouseEnter:P,onMouseLeave:F})})})]},s))}),(0,z.jsx)(a,{children:(0,z.jsx)(a,{"aria-busy":j,style:B.loadingPlaceholder,children:j?(0,z.jsx)(G,{count:x.count,rowHeight:n}):null})}),M&&o(v)&&!j?(0,z.jsx)(a,{style:B.emptyListContainer,children:v()}):null,(0,z.jsx)(a,{style:[B.scrollTracker,{height:f}],ref:O})]})})})}})},G=F,W.__docgenInfo={description:``,methods:[],displayName:`PlainListView`,props:{data:{required:!0,tsType:{name:`Array`,elements:[{name:`T`}],raw:`T[]`},description:``},keyExtractor:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(item: T, index: number) => string`,signature:{arguments:[{type:{name:`T`},name:`item`},{type:{name:`number`},name:`index`}],return:{name:`string`}}},description:``},highlightedRowId:{required:!1,tsType:{name:`string`},description:``},headerHeight:{required:!0,tsType:{name:`number`},description:``},rowHeight:{required:!0,tsType:{name:`number`},description:``},groupHeaderHeight:{required:!0,tsType:{name:`number`},description:``},extraInfo:{required:!0,tsType:{name:`ExtraInfo`},description:``},columns:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
//# sourceMappingURL=PlainListView.stories-CqqboAsQ.js.map