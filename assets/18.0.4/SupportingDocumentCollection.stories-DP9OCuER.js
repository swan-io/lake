import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-xecgKmXw.js";import{Bt as r,C as i,Et as a,G as o,J as s,K as ee,L as c,Lt as te,M as ne,O as l,R as u,U as d,W as re,et as f,g as ie,h as ae,ht as oe,i as p,l as m,o as h,r as g,s as se,u as _,vt as v}from"./ScrollView-CIA5lAtq.js";import{n as y,t as b}from"./commonStyles-IchN61IH.js";import{n as ce,r as x,t as S}from"./LakeButton-nkf7TWs4.js";import{a as C,d as le,f as ue,o as de,p as w,s as T}from"./i18n-CS8wWqmF.js";import{n as E,t as fe}from"./LakeLabel-CT3Mfu01.js";import{n as D,t as pe}from"./LakeCopyButton-DBRT88jO.js";import{n as O,t as me}from"./ReadOnlyFieldList-WQ1YXaOy.js";import{n as k,r as he,t as A}from"./_StoriesComponents-lD3emmMf.js";import{n as ge,t as j}from"./LakeModal-BputkX-W.js";import{n as _e,t as ve}from"./FilesUploader-fjcKIlOL.js";var ye,M,be=t((()=>{ye=e(n()),a(),y(),M=(0,ye.memo)(({ref:e,style:t,onReset:n,onSubmit:r,...i})=>te(`form`,{...i,ref:e,onReset:e=>{e.preventDefault(),n?.(e)},onSubmit:e=>{e.preventDefault(),r?.(e)},style:[b.view,t]})),M.displayName=`Form`})),N,P,xe,F,I,L,R,Se=t((()=>{i(),w(),ie(),be(),x(),D(),E(),se(),_(),O(),p(),v(),ee(),N=e(n()),a(),re(),C(),_e(),ge(),P=f(),xe=[`application/pdf`,`image/png`,`image/jpeg`,`image/heic`],F=r.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:`default`}}),I=e=>d(e).with({type:`tooltip`},({text:t,width:n})=>(0,P.jsx)(m,{content:t,width:n,togglableOnFocus:!0,placement:`right`,maxWidth:400,children:(0,P.jsx)(S,{mode:`tertiary`,size:`small`,color:`gray`,icon:e.icon??`question-circle-regular`,disabled:!0,style:[F.button,F.buttonWithDefaultCursor],ariaLabel:T(`supportingDocuments.help.whatIsThis`)})})).with({type:`button`},({label:t,onPress:n})=>(0,P.jsx)(S,{mode:`secondary`,size:`small`,color:`gray`,icon:e.icon??`question-circle-regular`,onPress:n,style:F.button,ariaLabel:T(`supportingDocuments.help.whatIsThis`),children:t})).exhaustive(),L=(e,t)=>d({language:e,country:t}).with(o.union({country:`FRA`},{country:o.nullish,language:`fr`}),()=>`https://support.swan.io/hc/${e}/articles/22502977563933`).with(o.union({country:`ITA`},{country:o.nullish,language:`it`}),()=>`https://support.swan.io/hc/${e}/articles/22537604831005`).with(o.union({country:`DEU`},{country:o.nullish,language:`de`}),()=>`https://support.swan.io/hc/${e}/articles/22535023588509`).with(o.union({country:`ESP`},{country:o.nullish,language:`es`}),()=>`https://support.swan.io/hc/${e}/articles/22544703221021`).with(o.union({country:`NLD`},{country:o.nullish,language:`nl`}),()=>`https://support.swan.io/hc/${e}/articles/22543228421277`).with(o.union({country:`BEL`}),()=>`https://support.swan.io/hc/${e}/articles/31233251462173`).otherwise(()=>`https://support.swan.io/hc/en-150/articles/22620756787869-Proof-of-company-registration`),R=({ref:e,documents:t,generateUpload:n,uploadFile:r,documentPurposes:i,templateLanguage:a=de.language,status:o,onChange:ee,onRemoveFile:te,showIds:l=!1,readOnly:u=!1,getPurposeMetadata:re,companyCountry:f,readonlyDocumentPurposes:ie=[]})=>{let[p,m]=(0,N.useState)(!1),[se,_]=(0,N.useState)(!1),[v,y]=(0,N.useState)(void 0),[b,x]=(0,N.useState)([]),C=(0,N.useMemo)(()=>{let e=new Set(Object.keys(i)),n=[...b,...t];return[...e].map(e=>{let t=n.filter(t=>t.purpose===e),r=t.length>0&&t.every(e=>e.file.statusInfo.status===`Validated`),a=i[e],o=a?.required===!0,s=r?0:o?1:2;return{purpose:e,files:t.map(e=>e.file),isRequired:o,areAllDocumentsValidated:r,priority:s,label:a?.label??e,description:a?.description,purposeDetails:a?.purposeDetails}}).toSorted((e,t)=>t.priority>e.priority?-1:1)},[i,t,b]),w=(0,N.useRef)(new Map(ne(C,({isRequired:e,purpose:t,files:n})=>e?c.Some([t,n]):c.None()))),E=(0,N.useRef)({});(0,N.useImperativeHandle)(e,()=>({areAllRequiredDocumentsFilled:()=>[...w.current.values()].every(e=>e.length>0),addDocument:e=>{x(t=>[...t,e])}})),(0,N.useEffect)(()=>{let e=b[b.length-1];e!=null&&E.current[e?.purpose]?.add(e.file)},[b]);let D=C.filter(({files:e})=>!(u&&e.length===0)),O=C.find(({purpose:e})=>e===`SwornStatement`);return(0,P.jsxs)(M,{children:[D.map(({purpose:e,files:t,areAllDocumentsValidated:i,isRequired:a,label:c,description:ne,purposeDetails:oe})=>{let p=re?.(e);return(0,P.jsxs)(N.Fragment,{children:[(0,P.jsx)(fe,{label:c,description:oe??ne,render:()=>(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(ae,{direction:`row`,children:[(0,P.jsx)(ae,{direction:`row`,children:s(p)?e===`CompanyRegistration`?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(S,{size:`small`,mode:`secondary`,icon:`question-circle-regular`,onPress:()=>window.open(L(de.language,f)),ariaLabel:T(`supportingDocuments.help.howToSendAGoodDocument`),children:T(`supportingDocuments.help.howToSendAGoodDocument`)}),(0,P.jsx)(g,{width:8})]}):(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(I,{type:`button`,label:p.title,onPress:()=>y(p)}),(0,P.jsx)(g,{width:8})]}):d(e).with(`CompanyRegistration`,()=>(0,P.jsx)(S,{size:`small`,mode:`secondary`,icon:`question-circle-regular`,onPress:()=>window.open(L(de.language,f)),ariaLabel:T(`supportingDocuments.help.howToSendAGoodDocument`),children:T(`supportingDocuments.help.howToSendAGoodDocument`)})).otherwise(()=>null)}),d(e).with(`PowerOfAttorney`,()=>(0,P.jsx)(I,{type:`button`,icon:`arrow-down-filled`,label:T(`supportingDocuments.help.downloadTemplate`),onPress:()=>m(!0)})).with(`SwornStatement`,()=>(0,P.jsx)(I,{type:`button`,icon:`arrow-down-filled`,label:T(`supportingDocuments.help.downloadTemplate`),onPress:()=>_(!0)})).otherwise(()=>null)]}),(0,P.jsx)(g,{height:16}),(0,P.jsx)(ve,{ref:t=>{E.current[e]=t},canUpload:!ie.includes(e)&&!u&&o===`WaitingForDocument`&&!i,accept:xe,maxSize:2e7,icon:`document-regular`,initialFiles:t,generateUpload:n,getUploadConfig:t=>({fileName:t.name,purpose:e}),uploadFile:s(r)?r:({upload:e,file:t,onProgress:n})=>{let r=new FormData;return e.fields.forEach(({key:e,value:t})=>r.append(e,t)),r.append(`file`,t),setTimeout(()=>n(.8),100),le.make({url:e.url,method:`POST`,body:r,type:`text`}).mapOkToResult(ue)},formatAndSizeDescription:T(`supportingDocuments.documentTypes`,{maxSizeMB:2e7/1e6}),onRemoveFile:u?void 0:te,onChange:t=>{if(a){w.current.set(e,t);let n=w.current.entries().reduce((e,[t,n])=>{let r=n.map(e=>({purpose:t,file:e}));return e.push(...r),e},[]);ee?.(n)}},showIds:l})]})}),(0,P.jsx)(g,{height:24})]},e)}),D.length===0?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(g,{height:24}),(0,P.jsx)(h,{align:`center`,children:T(`supportingDocuments.noDocuments`)}),(0,P.jsx)(g,{height:24})]}):null,(0,P.jsxs)(j,{visible:p,title:T(`supportingDocuments.powerOfAttorneyModal.title`),icon:`document-regular`,onPressClose:()=>m(!1),children:[(0,P.jsx)(h,{children:T(`supportingDocuments.powerOfAttorneyModal.description`)}),(0,P.jsx)(g,{height:16}),(0,P.jsx)(ce,{paddingBottom:0,children:(0,P.jsx)(S,{grow:!0,color:`current`,onPress:()=>window.open(`/power-of-attorney-template/${d(a).with(`fr`,()=>`fr`).with(`de`,()=>`de`).with(`es`,()=>`es`).with(`it`,()=>`it`).otherwise(()=>`en`)}.pdf`),children:T(`supportingDocuments.downloadTemplate`)})})]}),(0,P.jsxs)(j,{visible:se,title:O?.label??`Sworn Statement`,icon:`document-regular`,onPressClose:()=>_(!1),children:[(0,P.jsx)(h,{children:O?.description??``}),(0,P.jsx)(g,{height:16}),(0,P.jsx)(ce,{paddingBottom:0,children:(0,P.jsx)(S,{grow:!0,color:`current`,onPress:()=>{window.open(`/sworn-statement-template/${d(a).with(`nl`,()=>`nl`).with(`es`,()=>`es`).with(`it`,()=>`it`).otherwise(()=>`en`)}.pdf`)},children:T(`supportingDocuments.downloadTemplate`)})})]}),(0,P.jsx)(j,{visible:s(v),title:T(`supportingDocuments.informations`),icon:`document-regular`,onPressClose:()=>y(void 0),children:(0,P.jsx)(me,{children:v?.values.map(({title:e,value:t,type:n},r)=>(0,P.jsx)(fe,{type:`viewSmall`,label:e,actions:n===`copy`&&(0,P.jsx)(pe,{valueToCopy:t,copiedText:T(`copyButton.copiedTooltip`),copyText:T(`copyButton.copyTooltip`)}),render:()=>(0,P.jsx)(h,{variant:`regular`,color:oe.gray[900],children:t})},`metadata-${r}`))})})]})},R.__docgenInfo={description:``,methods:[{name:`areAllRequiredDocumentsFilled`,docblock:null,modifiers:[],params:[],returns:null},{name:`addDocument`,docblock:null,modifiers:[],params:[{name:`document`,optional:!1,type:null}],returns:null}],displayName:`SupportingDocumentCollection`,props:{ref:{required:!1,tsType:{name:`Ref`,elements:[{name:`signature`,type:`object`,raw:`{
...
//# sourceMappingURL=SupportingDocumentCollection.stories-DP9OCuER.js.map