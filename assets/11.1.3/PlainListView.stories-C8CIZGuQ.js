import{j as e}from"./jsx-runtime-BlAj40OV.js";import{r as n}from"./index-Cs7sjTYM.js";import{s as be,e as M,d as j,c as pe,i as A,h as he,V as m,j as Ne,m as ye,y as xe,B as we,S as B}from"./ScrollView-DAMcnhPN.js";import{V as Te,S as y,a as ie,b as R}from"./VirtualizedList-B7zJiIEc.js";import{L as W}from"./LakeButton-BsRwrvH_.js";import{a as Ce}from"./LakeCheckbox-NWcPwlVL.js";import{c as te}from"./commonStyles-CWvHnKRn.js";import{L as Se}from"./LakeHeading-XXdKUg9r.js";import{R as ke}from"./ResponsiveContainer-BcpmGxdZ.js";import{T as Ie}from"./Tag-BsNIDiwk.js";import{v as Re}from"./v4-DvF23Exx.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-DJFdew98.js";import"./function-B3wRQvvE.js";import"./Pressable-8N6ahZPW.js";import"./index-CJghV6hQ.js";import"./extends-CF3RwP-h.js";import"./index-Cp2lnEJT.js";const Me="inherit",r=be.create({root:{height:1,alignSelf:"stretch",flexGrow:1,backgroundColor:M.default},contentContainer:{flexDirection:"column",alignItems:"stretch",flexGrow:1},segment:{flexDirection:"row",alignItems:"stretch",overflow:"hidden",paddingHorizontal:j[8]},segmentLarge:{paddingHorizontal:j[24]},row:{boxShadow:`inset 0 -1px ${pe.gray[100]}`},activeRow:{backgroundColor:M.accented},hoveredRow:{backgroundColor:M.accented},segmentHeaderCell:{display:"flex",flexDirection:"row",alignItems:"center"},header:{position:"sticky",top:0,flexDirection:"row",alignItems:"stretch",zIndex:2},stickyHeader:{position:"sticky",backgroundColor:M.default90Transparency,backdropFilter:"blur(4px)",zIndex:10,paddingHorizontal:j[24],flexDirection:"row",alignItems:"center"},stickyHeaderLarge:{paddingHorizontal:j[40]},loadingPlaceholder:{position:"absolute",left:0,right:0,top:0},rowLink:{color:Me,textDecorationLine:"none"},emptyListContainer:{...te.fill,flexDirection:"column",alignItems:"center",justifyContent:"center",padding:j[48],backgroundColor:M.default},scrollTracker:{pointerEvents:"none",position:"absolute",left:0,bottom:0,right:0}}),V=1,re=0,Ee=({id:t,item:p,index:a,rowHeight:x,columns:h,extraInfo:C,isActive:S,isHovered:f,large:N,style:b,onMouseEnter:E,onMouseLeave:v})=>{const g=n.useRef(null);return xe(g,{onHoverStart:()=>E(t),onHoverEnd:()=>v()}),e.jsx(m,{ref:g,style:[r.segment,N&&r.segmentLarge,r.row,b==null?void 0:b(p,N),S&&r.activeRow,f&&r.hoveredRow,{minHeight:x}],children:h.map(({width:i,id:d,renderCell:c})=>e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof i=="number"?i:V,flexGrow:i==="grow"?V:re}],id:d,children:c({columnId:d,item:p,index:a,extraInfo:C,isHovered:f})},d))})},K=({data:t,keyExtractor:p,rowHeight:a,groupHeaderHeight:x,headerHeight:h,columns:C,smallColumns:S=C,extraInfo:f,onEndReached:N,onEndReachedThresholdPx:b=200,headerStyle:E,rowStyle:v,getRowLink:g,activeRowId:i,renderEmptyList:d,onActiveRowChange:c,groupBy:F,loading:w,breakpoint:le=ye.large,withoutScroll:q=!1,stickyOffset:de=0,headerBackgroundColor:se=M.default})=>{const oe=n.useId(),O=n.useRef(null),J=n.useMemo(()=>{if(F==null)return new Map([[null,t]]);const l=new Map;return t.forEach(o=>{const s=F(o);l.set(s,[...l.get(s)??[],o])}),l},[F,t]),Q=a*t.length+J.size*x,H=A(w)&&w.isLoading,D=t.length===0,[me,Z]=n.useState(void 0),ge=n.useCallback(()=>{Z(void 0)},[]);n.useEffect(()=>{const l=O.current;if(l!=null){const o=l,s=new IntersectionObserver(u=>{u.forEach(T=>{T.isIntersecting&&A(N)&&N()})});return s.observe(o),()=>s.unobserve(o)}},[N]);const ce=n.useCallback(({item:l,absoluteIndex:o,extraInfo:s})=>{const u=g==null?void 0:g({item:l,index:o,extraInfo:s});return he(u)?e.jsx(m,{}):u},[g]),Y=n.useRef(null);n.useEffect(()=>{const l=Y.current;if(i!=null&&l!=null){const o=l;o.scrollIntoView({behavior:"smooth",block:"nearest"}),c==null||c(o)}},[i,c]);const ue=n.useMemo(()=>q?e.jsx(m,{style:r.contentContainer}):e.jsx(Ne,{scrollEventThrottle:32,contentContainerStyle:[r.contentContainer,{minHeight:Q+(H?w.count*a:0)}]}),[H,w==null?void 0:w.count,a,Q,q]);return e.jsx(ke,{style:q?D?te.fill:void 0:r.root,breakpoint:le,children:({large:l})=>{const o=l?C:S;return e.jsx(e.Fragment,{children:n.cloneElement(ue,{children:e.jsxs(e.Fragment,{children:[!D&&l?e.jsx(m,{style:[r.segment,r.segmentLarge,r.header,E,{backgroundColor:se}],children:o.map(({id:s,width:u,title:T,renderTitle:k})=>{const I=`${oe}_${s}`;return e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof u=="number"?u:V,flexGrow:u==="grow"?V:re,height:h}],id:I,children:k({title:T,extraInfo:f,id:s})},I)})}):null,e.jsx(m,{children:Array.from(J.entries()).map(([s,u])=>e.jsxs(n.Fragment,{children:[s!=null?e.jsx(m,{style:[r.stickyHeader,l&&r.stickyHeaderLarge,{height:x,paddingTop:x/4,top:de+(l?h:0)}],children:e.jsx(Se,{level:3,variant:"h3",children:s})}):null,u.map((T,k)=>{const I=p(T,k),X=i===I,fe=A(g)&&me===I,U=ce({item:T,absoluteIndex:k,extraInfo:f});return n.cloneElement(U,{style:{...r.rowLink,...U.props.style},key:k,ref:X?Y:null,children:e.jsx(Ee,{id:I,rowHeight:a,columns:o,item:T,index:k,extraInfo:f,isActive:X,isHovered:fe,large:l,style:v,onMouseEnter:Z,onMouseLeave:ge})})})]},s))}),e.jsx(m,{children:e.jsx(m,{"aria-busy":H,style:r.loadingPlaceholder,children:H?e.jsx(ve,{count:w.count,rowHeight:a}):null})}),D&&A(d)&&!H?e.jsx(m,{style:r.emptyListContainer,children:d()}):null,e.jsx(m,{style:[r.scrollTracker,{height:b}],ref:O})]})})})}})},ve=Te;K.__docgenInfo={description:"",methods:[],displayName:"PlainListView",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},keyExtractor:{required:!0,tsType:{name:"signature",type:"function",raw:"(item: T, index: number) => string",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"string"}}},description:""},highlightedRowId:{required:!1,tsType:{name:"string"},description:""},headerHeight:{required:!0,tsType:{name:"number"},description:""},rowHeight:{required:!0,tsType:{name:"number"},description:""},groupHeaderHeight:{required:!0,tsType:{name:"number"},description:""},extraInfo:{required:!0,tsType:{name:"ExtraInfo"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
   ...
   */
  isHovered: boolean;
}`,signature:{properties:[{key:"columnId",value:{name:"string",required:!0}},{key:"item",value:{name:"T",required:!0}},{key:"index",value:{name:"number",required:!0}},{key:"extraInfo",value:{name:"ExtraInfo",required:!0}},{key:"isHovered",value:{name:"boolean",required:!0},description:"@deprecated Always false in VirtualizedList"}]}},name:"props"}],return:{name:"ReactNode"}},required:!0}}]}}],raw:"ColumnConfig<T, ExtraInfo>[]"},description:""},smallColumns:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
  renderTitle: (props: ColumnTitleConfig<ExtraInfo>) => ReactNode;
...
}`,...(ne=(ae=P.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};const _e=["Primary","MultiColumn"];export{P as MultiColumn,L as Primary,_e as __namedExportsOrder,ze as default};
//# sourceMappingURL=PlainListView.stories-C8CIZGuQ.js.map
