import{j as e}from"./jsx-runtime-8P-18mTY.js";import{r as n}from"./index-Cs7sjTYM.js";import{i as A,d as fe,V as m,s as be,j as pe,m as he,e as R,h as j,c as Ne,y as ye,B as xe,S as B}from"./ScrollView-OW9YrWpj.js";import{V as Te,T as y,H as x}from"./VirtualizedList-CpHs31DD.js";import{L as W}from"./LakeButton-7R4HcWD2.js";import{a as we}from"./LakeCheckbox-B6HTD0n7.js";import{c as ie}from"./commonStyles-BBEkV6IC.js";import{L as Ce}from"./LakeHeading-BsH-k9DS.js";import{R as ke}from"./ResponsiveContainer-Dvd59fpu.js";import{T as Ie}from"./Tag-IgXrc7Mg.js";import{v as Se}from"./v4-C6aID195.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BKZjgRaT.js";import"./Pressable-BgkE3IIw.js";import"./index-NvW6Cuj0.js";import"./extends-CF3RwP-h.js";import"./index-BcBU-lwX.js";const Me="inherit",r=be.create({root:{height:1,alignSelf:"stretch",flexGrow:1,backgroundColor:R.default},contentContainer:{flexDirection:"column",alignItems:"stretch",flexGrow:1},segment:{flexDirection:"row",alignItems:"stretch",overflow:"hidden",paddingHorizontal:j[16]},segmentLarge:{paddingHorizontal:j[32]},row:{boxShadow:`inset 0 -1px ${Ne.gray[100]}`},activeRow:{backgroundColor:R.accented},hoveredRow:{backgroundColor:R.accented},segmentHeaderCell:{display:"flex",flexDirection:"row",alignItems:"center"},header:{position:"sticky",top:0,flexDirection:"row",alignItems:"stretch",zIndex:2},stickyHeader:{position:"sticky",backgroundColor:R.default90Transparency,backdropFilter:"blur(4px)",zIndex:10,paddingHorizontal:j[24],flexDirection:"row",alignItems:"center"},stickyHeaderLarge:{paddingHorizontal:j[40]},loadingPlaceholder:{position:"absolute",left:0,right:0,top:0},rowLink:{color:Me,textDecorationLine:"none"},emptyListContainer:{...ie.fill,flexDirection:"column",alignItems:"center",justifyContent:"center",padding:j[48],backgroundColor:R.default},scrollTracker:{pointerEvents:"none",position:"absolute",left:0,bottom:0,right:0}}),K=1,te=0,Re=({id:t,item:p,index:a,rowHeight:T,columns:h,extraInfo:k,isActive:I,isHovered:f,large:N,style:b,onMouseEnter:v,onMouseLeave:E})=>{const g=n.useRef(null);return ye(g,{onHoverStart:()=>v(t),onHoverEnd:()=>E()}),e.jsx(m,{ref:g,style:[r.segment,N&&r.segmentLarge,r.row,b==null?void 0:b(p,N),I&&r.activeRow,f&&r.hoveredRow,{minHeight:T}],children:h.map(({width:i,id:d,renderCell:c})=>e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof i=="number"?i:K,flexGrow:i==="grow"?K:te}],id:d,children:c({columnId:d,item:p,index:a,extraInfo:k,isHovered:f})},d))})},q=({data:t,keyExtractor:p,rowHeight:a,groupHeaderHeight:T,headerHeight:h,columns:k,smallColumns:I=k,extraInfo:f,onEndReached:N,onEndReachedThresholdPx:b=200,headerStyle:v,rowStyle:E,getRowLink:g,activeRowId:i,renderEmptyList:d,onActiveRowChange:c,groupBy:F,loading:w,breakpoint:re=he.large,withoutScroll:D=!1,stickyOffset:le=0,headerBackgroundColor:de=R.default})=>{const se=n.useId(),O=n.useRef(null),J=n.useMemo(()=>{if(F==null)return new Map([[null,t]]);const l=new Map;return t.forEach(o=>{const s=F(o);l.set(s,[...l.get(s)??[],o])}),l},[F,t]),Q=a*t.length+J.size*T,H=A(w)&&w.isLoading,G=t.length===0,[oe,Z]=n.useState(void 0),me=n.useCallback(()=>{Z(void 0)},[]);n.useEffect(()=>{const l=O.current;if(l!=null){const o=l,s=new IntersectionObserver(u=>{u.forEach(C=>{C.isIntersecting&&A(N)&&N()})});return s.observe(o),()=>s.unobserve(o)}},[N]);const ge=n.useCallback(({item:l,absoluteIndex:o,extraInfo:s})=>{const u=g==null?void 0:g({item:l,index:o,extraInfo:s});return fe(u)?e.jsx(m,{}):u},[g]),Y=n.useRef(null);n.useEffect(()=>{const l=Y.current;if(i!=null&&l!=null){const o=l;o.scrollIntoView({behavior:"smooth",block:"nearest"}),c==null||c(o)}},[i,c]);const ce=n.useMemo(()=>D?e.jsx(m,{style:r.contentContainer}):e.jsx(pe,{scrollEventThrottle:32,contentContainerStyle:[r.contentContainer,{minHeight:Q+(H?w.count*a:0)}]}),[H,w==null?void 0:w.count,a,Q,D]);return e.jsx(ke,{style:D?G?ie.fill:void 0:r.root,breakpoint:re,children:({large:l})=>{const o=l?k:I;return e.jsx(e.Fragment,{children:n.cloneElement(ce,{children:e.jsxs(e.Fragment,{children:[!G&&l?e.jsx(m,{style:[r.segment,r.segmentLarge,r.header,v,{backgroundColor:de}],children:o.map(({id:s,width:u,title:C,renderTitle:S})=>{const M=`${se}_${s}`;return e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof u=="number"?u:K,flexGrow:u==="grow"?K:te,height:h}],id:M,children:S({title:C,extraInfo:f,id:s})},M)})}):null,e.jsx(m,{children:Array.from(J.entries()).map(([s,u])=>e.jsxs(n.Fragment,{children:[s!=null?e.jsx(m,{style:[r.stickyHeader,l&&r.stickyHeaderLarge,{height:T,paddingTop:T/4,top:le+(l?h:0)}],children:e.jsx(Ce,{level:3,variant:"h3",children:s})}):null,u.map((C,S)=>{const M=p(C,S),X=i===M,ue=A(g)&&oe===M,U=ge({item:C,absoluteIndex:S,extraInfo:f});return n.cloneElement(U,{style:{...r.rowLink,...U.props.style},key:S,ref:X?Y:null,children:e.jsx(Re,{id:M,rowHeight:a,columns:o,item:C,index:S,extraInfo:f,isActive:X,isHovered:ue,large:l,style:E,onMouseEnter:Z,onMouseLeave:me})})})]},s))}),e.jsx(m,{children:e.jsx(m,{"aria-busy":H,style:r.loadingPlaceholder,children:H?e.jsx(ve,{count:w.count,rowHeight:a}):null})}),G&&A(d)&&!H?e.jsx(m,{style:r.emptyListContainer,children:d()}):null,e.jsx(m,{style:[r.scrollTracker,{height:b}],ref:O})]})})})}})},ve=Te;q.__docgenInfo={description:"",methods:[],displayName:"PlainListView",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},keyExtractor:{required:!0,tsType:{name:"signature",type:"function",raw:"(item: T, index: number) => string",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"string"}}},description:""},highlightedRowId:{required:!1,tsType:{name:"string"},description:""},headerHeight:{required:!0,tsType:{name:"number"},description:""},rowHeight:{required:!0,tsType:{name:"number"},description:""},groupHeaderHeight:{required:!0,tsType:{name:"number"},description:""},extraInfo:{required:!0,tsType:{name:"ExtraInfo"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
//# sourceMappingURL=PlainListView.stories-YtBMK1fS.js.map
