import{c as e,i as t}from"./preload-helper-C6cs2Kqh.js";import{o as n}from"./iframe-DGcd-kjM.js";import{F as r,L as i,St as a,U as o,_ as s,bt as c,g as l,h as u,ht as d,i as f,it as p,n as m,nt as h,pt as g,r as _,rt as ee,st as v,t as te,v as y,z as ne}from"./ScrollView-SaAeE8cO.js";import{n as b,t as x}from"./commonStyles-BTA8ZveB.js";import{r as S,t as C}from"./LakeButton-DmmMWEyz.js";import{n as w,t as T}from"./Tag-B2GCLkoC.js";import{n as E,t as D}from"./dist-__3R7dOP.js";import{n as O,r as k}from"./LakeCheckbox-BoX6NkPt.js";import{n as A,t as re}from"./LakeHeading-Q_CBPVDj.js";import{n as j,t as ie}from"./ResponsiveContainer-CfEI322X.js";import{a as M,c as N,n as P,r as F,s as I}from"./VirtualizedList-BHB-QPxe.js";var L,R,z,B,V,H,U,W,ae=t((()=>{L=e(n()),d(),b(),v(),s(),r(),A(),j(),m(),F(),R=o(),z=a.create({root:{height:1,alignSelf:`stretch`,flexGrow:1,backgroundColor:h.default},contentContainer:{flexDirection:`column`,alignItems:`stretch`,flexGrow:1},segment:{flexDirection:`row`,alignItems:`stretch`,overflow:`hidden`,paddingHorizontal:g[16]},segmentLarge:{paddingHorizontal:g[32]},row:{boxShadow:`inset 0 -1px ${p.gray[100]}`},activeRow:{backgroundColor:h.accented},hoveredRow:{backgroundColor:h.accented},segmentHeaderCell:{display:`flex`,flexDirection:`row`,alignItems:`center`},header:{position:`sticky`,top:0,flexDirection:`row`,alignItems:`stretch`,zIndex:2},stickyHeader:{position:`sticky`,backgroundColor:h.default90Transparency,backdropFilter:`blur(4px)`,zIndex:10,paddingHorizontal:g[24],flexDirection:`row`,alignItems:`center`},stickyHeaderLarge:{paddingHorizontal:g[40]},loadingPlaceholder:{position:`absolute`,left:0,right:0,top:0},rowLink:{color:`inherit`,textDecorationLine:`none`},emptyListContainer:{...x.fill,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:g[48],backgroundColor:h.default},scrollTracker:{pointerEvents:`none`,position:`absolute`,left:0,bottom:0,right:0}}),B=1,V=0,H=({id:e,item:t,index:n,rowHeight:r,columns:i,extraInfo:a,isActive:o,isHovered:s,large:l,style:u,onMouseEnter:d,onMouseLeave:f})=>{let p=(0,L.useRef)(null);return y(p,{onHoverStart:()=>d(e),onHoverEnd:()=>f()}),(0,R.jsx)(c,{ref:p,style:[z.segment,l&&z.segmentLarge,z.row,u?.(t,l),o&&z.activeRow,s&&z.hoveredRow,{minHeight:r}],children:i.map(({width:e,id:r,renderCell:i})=>(0,R.jsx)(c,{style:[z.segmentHeaderCell,{width:typeof e==`number`?e:B,flexGrow:e===`grow`?B:V}],id:r,children:i({columnId:r,item:t,index:n,extraInfo:a,isHovered:s})},r))})},U=({data:e,keyExtractor:t,rowHeight:n,groupHeaderHeight:r,headerHeight:a,columns:o,smallColumns:s=o,extraInfo:l,onEndReached:u,onEndReachedThresholdPx:d=200,headerStyle:f,rowStyle:p,getRowLink:m,activeRowId:g,renderEmptyList:_,onActiveRowChange:v,groupBy:y,loading:b,breakpoint:S=ee.large,withoutScroll:C=!1,stickyOffset:w=0,headerBackgroundColor:T=h.default})=>{let E=(0,L.useId)(),D=(0,L.useRef)(null),O=(0,L.useMemo)(()=>{if(y==null)return new Map([[null,e]]);let t=new Map;return e.forEach(e=>{let n=y(e);t.set(n,[...t.get(n)??[],e])}),t},[y,e]),k=n*e.length+O.size*r,A=i(b)&&b.isLoading,j=e.length===0,[M,N]=(0,L.useState)(void 0),P=(0,L.useCallback)(()=>{N(void 0)},[]);(0,L.useEffect)(()=>{let e=D.current;if(e!=null){let t=e,n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&i(u)&&u()})});return n.observe(t),()=>n.unobserve(t)}},[u]);let F=(0,L.useCallback)(({item:e,absoluteIndex:t,extraInfo:n})=>{let r=m?.({item:e,index:t,extraInfo:n});return ne(r)?(0,R.jsx)(c,{}):r},[m]),I=(0,L.useRef)(null);(0,L.useEffect)(()=>{let e=I.current;if(g!=null&&e!=null){let t=e;t.scrollIntoView({behavior:`smooth`,block:`nearest`}),v?.(t)}},[g,v]);let U=(0,L.useMemo)(()=>C?(0,R.jsx)(c,{style:z.contentContainer}):(0,R.jsx)(te,{scrollEventThrottle:32,contentContainerStyle:[z.contentContainer,{minHeight:k+(A?b.count*n:0)}]}),[A,b?.count,n,k,C]);return(0,R.jsx)(ie,{style:C?j?x.fill:void 0:z.root,breakpoint:S,children:({large:e})=>{let u=e?o:s;return(0,R.jsx)(R.Fragment,{children:(0,L.cloneElement)(U,{children:(0,R.jsxs)(R.Fragment,{children:[!j&&e?(0,R.jsx)(c,{style:[z.segment,z.segmentLarge,z.header,f,{backgroundColor:T}],children:u.map(({id:e,width:t,title:n,renderTitle:r})=>{let i=`${E}_${e}`;return(0,R.jsx)(c,{style:[z.segmentHeaderCell,{width:typeof t==`number`?t:B,flexGrow:t===`grow`?B:V,height:a}],id:i,children:r({title:n,extraInfo:l,id:e})},i)})}):null,(0,R.jsx)(c,{children:Array.from(O.entries()).map(([o,s])=>(0,R.jsxs)(L.Fragment,{children:[o==null?null:(0,R.jsx)(c,{style:[z.stickyHeader,e&&z.stickyHeaderLarge,{height:r,paddingTop:r/4,top:w+(e?a:0)}],children:(0,R.jsx)(re,{level:3,variant:`h3`,children:o})}),s.map((r,a)=>{let o=t(r,a),s=g===o,c=i(m)&&M===o,d=F({item:r,absoluteIndex:a,extraInfo:l});return(0,L.cloneElement)(d,{style:{...z.rowLink,...d.props.style},key:a,ref:s?I:null,children:(0,R.jsx)(H,{id:o,rowHeight:n,columns:u,item:r,index:a,extraInfo:l,isActive:s,isHovered:c,large:e,style:p,onMouseEnter:N,onMouseLeave:P})})})]},o))}),(0,R.jsx)(c,{children:(0,R.jsx)(c,{"aria-busy":A,style:z.loadingPlaceholder,children:A?(0,R.jsx)(W,{count:b.count,rowHeight:n}):null})}),j&&i(_)&&!A?(0,R.jsx)(c,{style:z.emptyListContainer,children:_()}):null,(0,R.jsx)(c,{style:[z.scrollTracker,{height:d}],ref:D})]})})})}})},W=P,U.__docgenInfo={description:``,methods:[],displayName:`PlainListView`,props:{data:{required:!0,tsType:{name:`Array`,elements:[{name:`T`}],raw:`T[]`},description:``},keyExtractor:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(item: T, index: number) => string`,signature:{arguments:[{type:{name:`T`},name:`item`},{type:{name:`number`},name:`index`}],return:{name:`string`}}},description:``},highlightedRowId:{required:!1,tsType:{name:`string`},description:``},headerHeight:{required:!0,tsType:{name:`number`},description:``},rowHeight:{required:!0,tsType:{name:`number`},description:``},groupHeaderHeight:{required:!0,tsType:{name:`number`},description:``},extraInfo:{required:!0,tsType:{name:`ExtraInfo`},description:``},columns:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
}`,...Q.parameters?.docs?.source}}},$=[`Primary`,`MultiColumn`]}))();export{Q as MultiColumn,Z as Primary,$ as __namedExportsOrder,q as default};
//# sourceMappingURL=PlainListView.stories-CIT5sTvl.js.map