import{j as e}from"./jsx-runtime-BlAj40OV.js";import{r as n}from"./index-Cs7sjTYM.js";import{s as fe,e as v,d as j,c as be,i as A,h as pe,V as m,j as he,m as Ne,y as ye,B as xe,S as B}from"./ScrollView-DAMcnhPN.js";import{V as we,H as y,T as x}from"./VirtualizedList-7OR1j5Eb.js";import{L as W}from"./LakeButton-BsRwrvH_.js";import{a as Te}from"./LakeCheckbox-NWcPwlVL.js";import{c as ie}from"./commonStyles-CWvHnKRn.js";import{L as Ce}from"./LakeHeading-XXdKUg9r.js";import{R as ke}from"./ResponsiveContainer-BcpmGxdZ.js";import{T as Ie}from"./Tag-BsNIDiwk.js";import{v as Se}from"./v4-DvF23Exx.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-DJFdew98.js";import"./Pressable-8N6ahZPW.js";import"./index-CJghV6hQ.js";import"./extends-CF3RwP-h.js";import"./index-Cp2lnEJT.js";const Me="inherit",r=fe.create({root:{height:1,alignSelf:"stretch",flexGrow:1,backgroundColor:v.default},contentContainer:{flexDirection:"column",alignItems:"stretch",flexGrow:1},segment:{flexDirection:"row",alignItems:"stretch",overflow:"hidden",paddingHorizontal:j[8]},segmentLarge:{paddingHorizontal:j[24]},row:{boxShadow:`inset 0 -1px ${be.gray[100]}`},activeRow:{backgroundColor:v.accented},hoveredRow:{backgroundColor:v.accented},segmentHeaderCell:{display:"flex",flexDirection:"row",alignItems:"center"},header:{position:"sticky",top:0,flexDirection:"row",alignItems:"stretch",zIndex:2},stickyHeader:{position:"sticky",backgroundColor:v.default90Transparency,backdropFilter:"blur(4px)",zIndex:10,paddingHorizontal:j[24],flexDirection:"row",alignItems:"center"},stickyHeaderLarge:{paddingHorizontal:j[40]},loadingPlaceholder:{position:"absolute",left:0,right:0,top:0},rowLink:{color:Me,textDecorationLine:"none"},emptyListContainer:{...ie.fill,flexDirection:"column",alignItems:"center",justifyContent:"center",padding:j[48],backgroundColor:v.default},scrollTracker:{pointerEvents:"none",position:"absolute",left:0,bottom:0,right:0}}),V=1,te=0,ve=({id:t,item:p,index:a,rowHeight:w,columns:h,extraInfo:k,isActive:I,isHovered:f,large:N,style:b,onMouseEnter:R,onMouseLeave:E})=>{const g=n.useRef(null);return ye(g,{onHoverStart:()=>R(t),onHoverEnd:()=>E()}),e.jsx(m,{ref:g,style:[r.segment,N&&r.segmentLarge,r.row,b==null?void 0:b(p,N),I&&r.activeRow,f&&r.hoveredRow,{minHeight:w}],children:h.map(({width:i,id:s,renderCell:c})=>e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof i=="number"?i:V,flexGrow:i==="grow"?V:te}],id:s,children:c({columnId:s,item:p,index:a,extraInfo:k,isHovered:f})},s))})},K=({data:t,keyExtractor:p,rowHeight:a,groupHeaderHeight:w,headerHeight:h,columns:k,smallColumns:I=k,extraInfo:f,onEndReached:N,onEndReachedThresholdPx:b=200,headerStyle:R,rowStyle:E,getRowLink:g,activeRowId:i,renderEmptyList:s,onActiveRowChange:c,groupBy:F,loading:T,breakpoint:re=Ne.large,withoutScroll:q=!1,stickyOffset:le=0,headerBackgroundColor:se=v.default})=>{const de=n.useId(),O=n.useRef(null),J=n.useMemo(()=>{if(F==null)return new Map([[null,t]]);const l=new Map;return t.forEach(o=>{const d=F(o);l.set(d,[...l.get(d)??[],o])}),l},[F,t]),Q=a*t.length+J.size*w,H=A(T)&&T.isLoading,D=t.length===0,[oe,Z]=n.useState(void 0),me=n.useCallback(()=>{Z(void 0)},[]);n.useEffect(()=>{const l=O.current;if(l!=null){const o=l,d=new IntersectionObserver(u=>{u.forEach(C=>{C.isIntersecting&&A(N)&&N()})});return d.observe(o),()=>d.unobserve(o)}},[N]);const ge=n.useCallback(({item:l,absoluteIndex:o,extraInfo:d})=>{const u=g==null?void 0:g({item:l,index:o,extraInfo:d});return pe(u)?e.jsx(m,{}):u},[g]),Y=n.useRef(null);n.useEffect(()=>{const l=Y.current;if(i!=null&&l!=null){const o=l;o.scrollIntoView({behavior:"smooth",block:"nearest"}),c==null||c(o)}},[i,c]);const ce=n.useMemo(()=>q?e.jsx(m,{style:r.contentContainer}):e.jsx(he,{scrollEventThrottle:32,contentContainerStyle:[r.contentContainer,{minHeight:Q+(H?T.count*a:0)}]}),[H,T==null?void 0:T.count,a,Q,q]);return e.jsx(ke,{style:q?D?ie.fill:void 0:r.root,breakpoint:re,children:({large:l})=>{const o=l?k:I;return e.jsx(e.Fragment,{children:n.cloneElement(ce,{children:e.jsxs(e.Fragment,{children:[!D&&l?e.jsx(m,{style:[r.segment,r.segmentLarge,r.header,R,{backgroundColor:se}],children:o.map(({id:d,width:u,title:C,renderTitle:S})=>{const M=`${de}_${d}`;return e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof u=="number"?u:V,flexGrow:u==="grow"?V:te,height:h}],id:M,children:S({title:C,extraInfo:f,id:d})},M)})}):null,e.jsx(m,{children:Array.from(J.entries()).map(([d,u])=>e.jsxs(n.Fragment,{children:[d!=null?e.jsx(m,{style:[r.stickyHeader,l&&r.stickyHeaderLarge,{height:w,paddingTop:w/4,top:le+(l?h:0)}],children:e.jsx(Ce,{level:3,variant:"h3",children:d})}):null,u.map((C,S)=>{const M=p(C,S),X=i===M,ue=A(g)&&oe===M,U=ge({item:C,absoluteIndex:S,extraInfo:f});return n.cloneElement(U,{style:{...r.rowLink,...U.props.style},key:S,ref:X?Y:null,children:e.jsx(ve,{id:M,rowHeight:a,columns:o,item:C,index:S,extraInfo:f,isActive:X,isHovered:ue,large:l,style:E,onMouseEnter:Z,onMouseLeave:me})})})]},d))}),e.jsx(m,{children:e.jsx(m,{"aria-busy":H,style:r.loadingPlaceholder,children:H?e.jsx(Re,{count:T.count,rowHeight:a}):null})}),D&&A(s)&&!H?e.jsx(m,{style:r.emptyListContainer,children:s()}):null,e.jsx(m,{style:[r.scrollTracker,{height:b}],ref:O})]})})})}})},Re=we;K.__docgenInfo={description:"",methods:[],displayName:"PlainListView",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},keyExtractor:{required:!0,tsType:{name:"signature",type:"function",raw:"(item: T, index: number) => string",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"string"}}},description:""},highlightedRowId:{required:!1,tsType:{name:"string"},description:""},headerHeight:{required:!0,tsType:{name:"number"},description:""},rowHeight:{required:!0,tsType:{name:"number"},description:""},groupHeaderHeight:{required:!0,tsType:{name:"number"},description:""},extraInfo:{required:!0,tsType:{name:"ExtraInfo"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
  ...
  index: number;
  extraInfo: ExtraInfo;
}`,signature:{properties:[{key:"columnId",value:{name:"string",required:!0}},{key:"item",value:{name:"T",required:!0}},{key:"isHovered",value:{name:"boolean",required:!0},description:"isHovered is only set for PlainListView"},{key:"index",value:{name:"number",required:!0}},{key:"extraInfo",value:{name:"ExtraInfo",required:!0}}]}},name:"props"}],return:{name:"ReactNode"}},required:!0}}]}}],raw:"ColumnConfig<T, ExtraInfo>[]"},description:""},smallColumns:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
  renderTitle: (props: ColumnTitleConfig<ExtraInfo>) => ReactNode;
...
//# sourceMappingURL=PlainListView.stories-Bgk2kA-l.js.map
