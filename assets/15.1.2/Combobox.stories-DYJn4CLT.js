const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./placekit-lite-DY_WV8ir.js","./preload-helper-B45gAKPr.js"])))=>i.map(i=>d[i]);
import{c as e,i as t,n,t as r}from"./preload-helper-B45gAKPr.js";import{o as i}from"./iframe-Ds3sea8g.js";import{A as a,C as o,D as s,E as c,M as l,N as u,O as d,P as f,U as p,bt as m,g as h,h as g,ht as _,it as v,kt as y,o as b,s as x,st as ee,w as S}from"./ScrollView-h2xCiEKZ.js";import{n as te,t as ne}from"./Separator-BG49ODdt.js";import{i as re,o as ie}from"./i18n-DpkI66ZE.js";import{n as C,t as w}from"./LakeCombobox-DV0wc7jw.js";import{n as T,r as E,t as D}from"./_StoriesComponents-BPwtHyz7.js";import{c as O,i as k,n as A}from"./countries-QHr5hSSp.js";var j,M,N,P,F=t((()=>{c(),j=e(i()),_(),u(),ee(),C(),x(),te(),M=p(),N=y.create({unselectable:{userSelect:`none`}}),P=({inputRef:e,value:t,onValueChange:n,disabled:r,id:i,placeholder:a,error:o,emptyResult:c,ListFooterComponent:u,shouldDisplaySuggestions:d=!0,loadSuggestions:p,onSuggestion:m,onLoadError:h})=>{let[g,_]=(0,j.useState)(S.NotAsked()),y=(0,j.useRef)(void 0);return(0,M.jsx)(w,{inputRef:e,id:i,placeholder:a,value:t??``,items:g,icon:p==null?void 0:`search-filled`,disabled:r,error:o,ListFooterComponent:u!=null&&(0,M.jsxs)(M.Fragment,{children:[l(g).with(S.P.Done(s.P.Ok(f.select())),e=>e.length>0?(0,M.jsx)(ne,{}):null).otherwise(()=>null),u]}),onSelectItem:e=>{m(e)},onValueChange:e=>{if(y.current?.cancel(),y.current=void 0,n(e),e.length<=3||!d)return _(S.NotAsked());if(p!=null){_(S.Loading());let t=p(e);y.current=t,h!=null&&t.tapError(h),t.onResolve(e=>_(S.Done(e)))}},keyExtractor:e=>`${e.title} ${e.subtitle}`,emptyResult:c,renderItem:e=>(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(b,{numberOfLines:1,style:N.unselectable,color:v.gray[900],children:e.title}),(0,M.jsx)(b,{numberOfLines:1,style:N.unselectable,variant:`smallRegular`,children:e.subtitle})]})})},P.__docgenInfo={description:``,methods:[],displayName:`AutocompleteSearchInput`,props:{inputRef:{required:!1,tsType:{name:`Ref`,elements:[{name:`unknown`}],raw:`Ref<unknown>`},description:``},value:{required:!1,tsType:{name:`string`},description:``},onValueChange:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(value: string) => void`,signature:{arguments:[{type:{name:`string`},name:`value`}],return:{name:`void`}}},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``},id:{required:!1,tsType:{name:`string`},description:``},placeholder:{required:!1,tsType:{name:`string`},description:``},error:{required:!1,tsType:{name:`string`},description:``},emptyResult:{required:!0,tsType:{name:`string`},description:``},ListFooterComponent:{required:!1,tsType:{name:`ReactNode`},description:``},shouldDisplaySuggestions:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`true`,computed:!1}},loadSuggestions:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(value: string) => Future<Result<Suggestion<T>[], unknown>>`,signature:{arguments:[{type:{name:`string`},name:`value`}],return:{name:`Future`,elements:[{name:`Result`,elements:[{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  title: string;
  subtitle: string;
  value: T;
...
//# sourceMappingURL=Combobox.stories-DYJn4CLT.js.map