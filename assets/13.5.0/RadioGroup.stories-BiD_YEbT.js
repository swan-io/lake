import{j as e,B as g,i as T,S as w,L as p,c as d,g as b,s as G,d as h}from"./ScrollView-DByaBlwc.js";import{r as j}from"./iframe-BovOOO-W.js";import{L as V}from"./LakeRadio-Catcpvwf.js";import{P as W}from"./Pressable-1f-2DTAF.js";import{S as k,a}from"./_StoriesComponents-duxOczes.js";import"./index-CvrZlHcx.js";import"./preload-helper-D1IIBeq1.js";import"./Separator-DyMh-TYE.js";import"./commonStyles-BBEkV6IC.js";const o=G.create({container:{flexWrap:"wrap"},item:{flexDirection:"row",alignItems:"center"},withRightSpace:{marginRight:h[24]},withBottomSpace:{marginBottom:h[12]},errorContainer:{paddingTop:h[4]}});function v({items:n,direction:i="column",color:u="current",disabled:S=!1,hideErrors:R=!1,error:m,help:B,value:y,onValueChange:P}){const E=b(m);return e.jsxs(e.Fragment,{children:[e.jsx(g,{direction:i,style:o.container,children:n.map((l,f)=>{const x=f===n.length-1,c=S||!T(l.disabled);return e.jsxs(j.Fragment,{children:[e.jsxs(W,{disabled:c,onPress:()=>{l.value!==y&&P(l.value)},style:[o.item,i==="row"&&o.withBottomSpace,i==="row"&&!x&&o.withRightSpace],children:[e.jsx(V,{isError:E,disabled:c,color:u,value:l.value===y}),e.jsx(w,{width:12}),e.jsx(p,{color:c?d.gray[300]:d.gray[900],children:l.name})]}),!x&&e.jsx(w,{height:i==="column"?12:void 0})]},f)})}),!R&&e.jsx(g,{direction:"row",style:o.errorContainer,children:b(m)?e.jsx(p,{variant:"smallRegular",color:d.negative[500],children:m}):e.jsx(p,{variant:"smallRegular",color:d.gray[500],children:B??" "})})]})}v.__docgenInfo={description:"",methods:[],displayName:"RadioGroup",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  name: string;
  value: V;
  disabled?: boolean;
...
//# sourceMappingURL=RadioGroup.stories-BiD_YEbT.js.map
