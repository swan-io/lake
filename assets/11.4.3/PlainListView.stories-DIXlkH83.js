import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as n}from"./index-D9D9kDko.js";import{i as V,d as fe,V as m,s as be,j as pe,m as he,e as v,h as j,c as Ne,y as ye,B as we,S as q}from"./ScrollView-BXYY5pE1.js";import{V as xe,T as y,H as w}from"./VirtualizedList-AD2sp1G8.js";import{L as W}from"./LakeButton-DLnA0Wvw.js";import{a as Te}from"./LakeCheckbox-Bf45kYLh.js";import{c as ie}from"./commonStyles-BBEkV6IC.js";import{L as Ce}from"./LakeHeading-vlTDShQo.js";import{R as ke}from"./ResponsiveContainer-CGDNTJ2M.js";import{T as Ie}from"./Tag-BZRwK38S.js";import{v as Se}from"./v4-C6aID195.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-D0hBKHsB.js";import"./Pressable-Bcg9LWlT.js";import"./index-BiKzkAzw.js";import"./extends-CF3RwP-h.js";import"./index-CmAykTSy.js";const Me="inherit",r=be.create({root:{height:1,alignSelf:"stretch",flexGrow:1,backgroundColor:v.default},contentContainer:{flexDirection:"column",alignItems:"stretch",flexGrow:1},segment:{flexDirection:"row",alignItems:"stretch",overflow:"hidden",paddingHorizontal:j[16]},segmentLarge:{paddingHorizontal:j[32]},row:{boxShadow:`inset 0 -1px ${Ne.gray[100]}`},activeRow:{backgroundColor:v.accented},hoveredRow:{backgroundColor:v.accented},segmentHeaderCell:{display:"flex",flexDirection:"row",alignItems:"center"},header:{position:"sticky",top:0,flexDirection:"row",alignItems:"stretch",zIndex:2},stickyHeader:{position:"sticky",backgroundColor:v.default90Transparency,backdropFilter:"blur(4px)",zIndex:10,paddingHorizontal:j[24],flexDirection:"row",alignItems:"center"},stickyHeaderLarge:{paddingHorizontal:j[40]},loadingPlaceholder:{position:"absolute",left:0,right:0,top:0},rowLink:{color:Me,textDecorationLine:"none"},emptyListContainer:{...ie.fill,flexDirection:"column",alignItems:"center",justifyContent:"center",padding:j[48],backgroundColor:v.default},scrollTracker:{pointerEvents:"none",position:"absolute",left:0,bottom:0,right:0}}),A=1,te=0,ve=({id:t,item:p,index:a,rowHeight:x,columns:h,extraInfo:k,isActive:I,isHovered:f,large:N,style:b,onMouseEnter:E,onMouseLeave:R})=>{const g=n.useRef(null);return ye(g,{onHoverStart:()=>E(t),onHoverEnd:()=>R()}),e.jsx(m,{ref:g,style:[r.segment,N&&r.segmentLarge,r.row,b==null?void 0:b(p,N),I&&r.activeRow,f&&r.hoveredRow,{minHeight:x}],children:h.map(({width:i,id:d,renderCell:c})=>e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof i=="number"?i:A,flexGrow:i==="grow"?A:te}],id:d,children:c({columnId:d,item:p,index:a,extraInfo:k,isHovered:f})},d))})},B=({data:t,keyExtractor:p,rowHeight:a,groupHeaderHeight:x,headerHeight:h,columns:k,smallColumns:I=k,extraInfo:f,onEndReached:N,onEndReachedThresholdPx:b=200,headerStyle:E,rowStyle:R,getRowLink:g,activeRowId:i,renderEmptyList:d,onActiveRowChange:c,groupBy:F,loading:T,breakpoint:re=he.large,withoutScroll:K=!1,stickyOffset:le=0,headerBackgroundColor:de=v.default})=>{const se=n.useId(),O=n.useRef(null),J=n.useMemo(()=>{if(F==null)return new Map([[null,t]]);const l=new Map;return t.forEach(o=>{const s=F(o);l.set(s,[...l.get(s)??[],o])}),l},[F,t]),Q=a*t.length+J.size*x,H=V(T)&&T.isLoading,D=t.length===0,[oe,Z]=n.useState(void 0),me=n.useCallback(()=>{Z(void 0)},[]);n.useEffect(()=>{const l=O.current;if(l!=null){const o=l,s=new IntersectionObserver(u=>{u.forEach(C=>{C.isIntersecting&&V(N)&&N()})});return s.observe(o),()=>s.unobserve(o)}},[N]);const ge=n.useCallback(({item:l,absoluteIndex:o,extraInfo:s})=>{const u=g==null?void 0:g({item:l,index:o,extraInfo:s});return fe(u)?e.jsx(m,{}):u},[g]),Y=n.useRef(null);n.useEffect(()=>{const l=Y.current;if(i!=null&&l!=null){const o=l;o.scrollIntoView({behavior:"smooth",block:"nearest"}),c==null||c(o)}},[i,c]);const ce=n.useMemo(()=>K?e.jsx(m,{style:r.contentContainer}):e.jsx(pe,{scrollEventThrottle:32,contentContainerStyle:[r.contentContainer,{minHeight:Q+(H?T.count*a:0)}]}),[H,T==null?void 0:T.count,a,Q,K]);return e.jsx(ke,{style:K?D?ie.fill:void 0:r.root,breakpoint:re,children:({large:l})=>{const o=l?k:I;return e.jsx(e.Fragment,{children:n.cloneElement(ce,{children:e.jsxs(e.Fragment,{children:[!D&&l?e.jsx(m,{style:[r.segment,r.segmentLarge,r.header,E,{backgroundColor:de}],children:o.map(({id:s,width:u,title:C,renderTitle:S})=>{const M=`${se}_${s}`;return e.jsx(m,{style:[r.segmentHeaderCell,{width:typeof u=="number"?u:A,flexGrow:u==="grow"?A:te,height:h}],id:M,children:S({title:C,extraInfo:f,id:s})},M)})}):null,e.jsx(m,{children:Array.from(J.entries()).map(([s,u])=>e.jsxs(n.Fragment,{children:[s!=null?e.jsx(m,{style:[r.stickyHeader,l&&r.stickyHeaderLarge,{height:x,paddingTop:x/4,top:le+(l?h:0)}],children:e.jsx(Ce,{level:3,variant:"h3",children:s})}):null,u.map((C,S)=>{const M=p(C,S),X=i===M,ue=V(g)&&oe===M,U=ge({item:C,absoluteIndex:S,extraInfo:f});return n.cloneElement(U,{style:{...r.rowLink,...U.props.style},key:S,ref:X?Y:null,children:e.jsx(ve,{id:M,rowHeight:a,columns:o,item:C,index:S,extraInfo:f,isActive:X,isHovered:ue,large:l,style:R,onMouseEnter:Z,onMouseLeave:me})})})]},s))}),e.jsx(m,{children:e.jsx(m,{"aria-busy":H,style:r.loadingPlaceholder,children:H?e.jsx(Ee,{count:T.count,rowHeight:a}):null})}),D&&V(d)&&!H?e.jsx(m,{style:r.emptyListContainer,children:d()}):null,e.jsx(m,{style:[r.scrollTracker,{height:b}],ref:O})]})})})}})},Ee=xe;B.__docgenInfo={description:"",methods:[],displayName:"PlainListView",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},keyExtractor:{required:!0,tsType:{name:"signature",type:"function",raw:"(item: T, index: number) => string",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"string"}}},description:""},highlightedRowId:{required:!1,tsType:{name:"string"},description:""},headerHeight:{required:!0,tsType:{name:"number"},description:""},rowHeight:{required:!0,tsType:{name:"number"},description:""},groupHeaderHeight:{required:!0,tsType:{name:"number"},description:""},extraInfo:{required:!0,tsType:{name:"ExtraInfo"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  width: number | "grow";
  title: string;
  ...
  index: number;
  extraInfo: ExtraInfo;
}`,signature:{properties:[{key:"columnId",value:{name:"string",required:!0}},{key:"item",value:{name:"T",required:!0}},{key:"isHovered",value:{name:"boolean",required:!0}},{key:"index",value:{name:"number",required:!0}},{key:"extraInfo",value:{name:"ExtraInfo",required:!0}}]}},name:"props"}],return:{name:"ReactNode"}},required:!0}}]}}],raw:"ColumnConfig<T, ExtraInfo>[]"},description:"",defaultValue:{value:"columns",computed:!1}},onEndReached:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onEndReachedThresholdPx:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"200",computed:!1}},headerStyle:{required:!1,tsType:{name:"union",raw:"ViewStyle | null | undefined",elements:[{name:"ViewStyle"},{name:"null"},{name:"undefined"}]},description:""},rowStyle:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: T, large: boolean) => ViewStyle | null | undefined",signature:{arguments:[{type:{name:"T"},name:"item"},{type:{name:"boolean"},name:"large"}],return:{name:"union",raw:"ViewStyle | null | undefined",elements:[{name:"ViewStyle"},{name:"null"},{name:"undefined"}]}}},description:""},getRowLink:{required:!1,tsType:{name:"signature",type:"function",raw:`(config: LinkConfig<T, ExtraInfo>) => ReactElement<{
  children: ReactNode;
  ref?: Ref<View>;
  style?: ViewStyle;
...
}`,...(ne=(ae=P.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};const We=["Primary","MultiColumn"];export{P as MultiColumn,L as Primary,We as __namedExportsOrder,Ue as default};
//# sourceMappingURL=PlainListView.stories-DIXlkH83.js.map
