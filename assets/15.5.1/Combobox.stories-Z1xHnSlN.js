const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./placekit-lite-D7Fijc76.js","./preload-helper-CCSz8wUY.js"])))=>i.map(i=>d[i]);
import{c as e,i as t,n,t as r}from"./preload-helper-CCSz8wUY.js";import{o as i}from"./iframe-nQ40J3IX.js";import{A as a,C as o,D as s,E as c,M as l,N as u,O as d,P as f,U as p,g as m,h,ht as g,it as _,kt as v,o as y,s as b,st as x,vt as ee,w as S}from"./ScrollView-DLC7st41.js";import{n as te,t as ne}from"./Separator-5W6TM1mX.js";import{a as re,s as ie}from"./i18n-2-xWLOd0.js";import{n as C,t as w}from"./LakeCombobox-DaWL4Z4h.js";import{n as T,r as E,t as D}from"./_StoriesComponents-CxUpQl3G.js";import{c as O,i as k,n as A}from"./countries-Df_T1c4N.js";var j,M,N,P,F=t((()=>{c(),j=e(i()),g(),u(),x(),C(),b(),te(),M=p(),N=v.create({unselectable:{userSelect:`none`}}),P=({inputRef:e,value:t,onValueChange:n,disabled:r,id:i,placeholder:a,error:o,emptyResult:c,ListFooterComponent:u,shouldDisplaySuggestions:d=!0,loadSuggestions:p,onSuggestion:m,onLoadError:h})=>{let[g,v]=(0,j.useState)(S.NotAsked()),b=(0,j.useRef)(void 0);return(0,M.jsx)(w,{inputRef:e,id:i,placeholder:a,value:t??``,items:g,icon:p==null?void 0:`search-filled`,disabled:r,error:o,ListFooterComponent:u!=null&&(0,M.jsxs)(M.Fragment,{children:[l(g).with(S.P.Done(s.P.Ok(f.select())),e=>e.length>0?(0,M.jsx)(ne,{}):null).otherwise(()=>null),u]}),onSelectItem:e=>{m(e)},onValueChange:e=>{if(b.current?.cancel(),b.current=void 0,n(e),e.length<=3||!d)return v(S.NotAsked());if(p!=null){v(S.Loading());let t=p(e);b.current=t,h!=null&&t.tapError(h),t.onResolve(e=>v(S.Done(e)))}},keyExtractor:e=>`${e.title} ${e.subtitle}`,emptyResult:c,renderItem:e=>(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(y,{numberOfLines:1,style:N.unselectable,color:_.gray[900],children:e.title}),(0,M.jsx)(y,{numberOfLines:1,style:N.unselectable,variant:`smallRegular`,children:e.subtitle})]})})},P.__docgenInfo={description:``,methods:[],displayName:`AutocompleteSearchInput`,props:{inputRef:{required:!1,tsType:{name:`Ref`,elements:[{name:`unknown`}],raw:`Ref<unknown>`},description:``},value:{required:!1,tsType:{name:`string`},description:``},onValueChange:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(value: string) => void`,signature:{arguments:[{type:{name:`string`},name:`value`}],return:{name:`void`}}},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``},id:{required:!1,tsType:{name:`string`},description:``},placeholder:{required:!1,tsType:{name:`string`},description:``},error:{required:!1,tsType:{name:`string`},description:``},emptyResult:{required:!0,tsType:{name:`string`},description:``},ListFooterComponent:{required:!1,tsType:{name:`ReactNode`},description:``},shouldDisplaySuggestions:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`true`,computed:!1}},loadSuggestions:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(value: string) => Future<Result<Suggestion<T>[], unknown>>`,signature:{arguments:[{type:{name:`string`},name:`value`}],return:{name:`Future`,elements:[{name:`Result`,elements:[{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  title: string;
  subtitle: string;
  value: T;
...
//# sourceMappingURL=Combobox.stories-Z1xHnSlN.js.map