import{j as e,B,S,L as I,c as C,h as L,s as w,V as D}from"./ScrollView-CwRta2uu.js";import{a as A}from"./LakeButton-YVWrp7lC.js";import{L as E}from"./LakeLabel-ChpspnVK.js";import{u as W}from"./index-9Ob0fDjU.js";import{L as _}from"./LakeTextInput-0O_bBayQ.js";import{r as k}from"./iframe--f1go8Pa.js";import{p as O,b as N}from"./countries-Dh4MefTo.js";import{P as z}from"./PhoneCountryPicker-CyK3LwcX.js";import{S as G,a as t}from"./_StoriesComponents-CLyBSWgF.js";import"./index-1Ny4tXn4.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-DsjXsWn7.js";import"./index-BP6TKObu.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-8jL2C8bE.js";import"./LakeSelect-vicqUR2J.js";import"./i18n-JxmJv1Y7.js";import"./array-BfAlyugE.js";import"./useBoolean-kxrwTIS_.js";import"./useDisclosure-BkwijpDf.js";import"./FocusTrap-Xg4aXcdN.js";import"./FlatList-ByvFx_4y.js";import"./Popover-BD8UwXJt.js";import"./useResponsive-Bs30hDw5.js";import"./function-C3rhzPll.js";import"./BottomPanel-BQmnotZH.js";import"./useBodyClassName-ByytCsni.js";import"./Suspendable-Bl81yrf9.js";import"./TransitionView-3J-zYzMx.js";import"./index-BZSkXHZy.js";import"./Separator-SiwiLAfX.js";import"./preload-helper-D1IIBeq1.js";import"./string-vWOQI9cl.js";import"./Flag-ebZ3IShX.js";const j=w.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:c,id:d,country:m,value:p,countries:y,error:a,help:g,valid:f=!1,autofocus:r=!1,disabled:n=!1,readOnly:o=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:P,onSubmitEditing:s,onBlur:T})=>{const u=k.useRef(null),R=x=>{const F=x.replace(/[^ +0-9-()]/g,"");x===F&&P(x)};k.useEffect(()=>{r&&u.current&&setTimeout(()=>u.current?.focus(),250)},[r,m]),k.useImperativeHandle(c,()=>({focus:()=>u.current?.focus(),blur:()=>u.current?.blur()}),[]);const V=[j.picker,(n||o)&&j.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:m,countries:y??O,onValueChange:v,disabled:n,readOnly:o,error:a,ariaLabel:b,style:V}),e.jsx(_,{id:d,ref:u,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:p,valid:f,error:a,disabled:n,readOnly:o,onChangeText:R,onSubmitEditing:s,onBlur:T,style:j.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(S,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(a)?C.negative[500]:C.gray[500],children:a??g??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-NYvvjI0F.js.map
