import{j as e,B,S,L as I,c as C,h as L,s as w,V as D}from"./ScrollView-D0eHMW9u.js";import{a as A}from"./LakeButton-UCnu8mwq.js";import{L as E}from"./LakeLabel-CCB-L70s.js";import{u as W}from"./index-BSvcRwJa.js";import{L as _}from"./LakeTextInput-DRN6MWSM.js";import{r as k}from"./iframe-I_zhAHSZ.js";import{p as O,b as N}from"./countries-Ck6-kSlK.js";import{P as z}from"./PhoneCountryPicker-uPl3ECLT.js";import{S as G,a as t}from"./_StoriesComponents-BGQXwHQ8.js";import"./index-nmojPuxQ.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-CzqhAcYg.js";import"./index-BUef1l32.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-DPlfr9LZ.js";import"./LakeSelect-wBB1A3lv.js";import"./i18n-pdKponm_.js";import"./array-BfAlyugE.js";import"./useBoolean-BfZOYiLt.js";import"./useDisclosure-DxqCMjjy.js";import"./FocusTrap-B2D6zT1J.js";import"./FlatList-DQ17J3dn.js";import"./Popover-BxFjU2yO.js";import"./useResponsive-CnPNojAi.js";import"./function-DLOc_IHQ.js";import"./BottomPanel-WUgTR9rw.js";import"./useBodyClassName-D-de-nu-.js";import"./Suspendable-Cq8MLLTV.js";import"./TransitionView-DOOghWVz.js";import"./index-CLXkQ942.js";import"./Separator-DBVLfx5C.js";import"./preload-helper-D1IIBeq1.js";import"./string-WmltlUqI.js";import"./Flag-CcFdWuiF.js";const j=w.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:c,id:d,country:m,value:p,countries:y,error:a,help:g,valid:f=!1,autofocus:r=!1,disabled:n=!1,readOnly:o=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:P,onSubmitEditing:s,onBlur:T})=>{const u=k.useRef(null),R=x=>{const F=x.replace(/[^ +0-9-()]/g,"");x===F&&P(x)};k.useEffect(()=>{r&&u.current&&setTimeout(()=>u.current?.focus(),250)},[r,m]),k.useImperativeHandle(c,()=>({focus:()=>u.current?.focus(),blur:()=>u.current?.blur()}),[]);const V=[j.picker,(n||o)&&j.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:m,countries:y??O,onValueChange:v,disabled:n,readOnly:o,error:a,ariaLabel:b,style:V}),e.jsx(_,{id:d,ref:u,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:p,valid:f,error:a,disabled:n,readOnly:o,onChangeText:R,onSubmitEditing:s,onBlur:T,style:j.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(S,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(a)?C.negative[500]:C.gray[500],children:a??g??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-YQ3py0c-.js.map
