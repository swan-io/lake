import{G as Se,y as Pe,p as J,j as e,B as re,f as z,S as h,M as q,L as W,c as ke,a0 as je,s as qe,P as V,k as L}from"./ScrollView-C3wCFhy6.js";import{a as P,L as oe}from"./LakeButton-BX4p7owg.js";import{r as i}from"./iframe-DoGs6GYv.js";import{c as Ie}from"./commonStyles-BBEkV6IC.js";import{L as Re}from"./LakeCopyButton-B-mlA3rS.js";import{L as se}from"./LakeLabel-DmUuZmSY.js";import{R as Fe}from"./ReadOnlyFieldList-DEGj2CSH.js";import{t as o,l as G,m as be,v as xe,i as ue}from"./i18n-DbklHmen.js";import{F as Ce}from"./FilesUploader-BIRIl2zj.js";import{L as $}from"./LakeModal-BOmbL1QA.js";import{S as m,a as c}from"./_StoriesComponents-MaKF7A1A.js";import"./index-C0HKAucw.js";import"./Pressable-C1pQujiA.js";import"./index-CjAoJD55.js";import"./extends-CF3RwP-h.js";import"./preload-helper-D1IIBeq1.js";import"./clipboard-BXAk6GqW.js";import"./v4-EwEgHOG0.js";import"./Separator-CsqT-NZ9.js";import"./rifm-BEAdPzzj.js";import"./array-BfAlyugE.js";import"./FileInput-OB_ioIn2.js";import"./LakeHeading-Ci4RnxKW.js";import"./useBoolean-6pWGv3TL.js";import"./LakeAlert-DWWLHzNF.js";import"./useResponsive-C7aOIX-n.js";import"./Tag-CvwxZsbQ.js";import"./index-FCuI_pbQ.js";import"./FocusTrap-DoBpk5KX.js";import"./Suspendable-Dj5_SgZ_.js";import"./ResponsiveContainer-CcjHs1dV.js";import"./TransitionView-BzTqP2uv.js";import"./useBodyClassName-C6zjzgot.js";const ie=i.memo(({ref:n,style:r,onReset:l,onSubmit:k,...I})=>Se("form",{...I,ref:n,onReset:y=>{y.preventDefault(),l?.(y)},onSubmit:y=>{y.preventDefault(),k?.(y)},style:[Ie.view,r]}));ie.displayName="Form";const Oe=["application/pdf","image/png","image/jpeg","image/heic"],H=qe.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:"default"}}),K=n=>q(n).with({type:"tooltip"},({text:r,width:l})=>e.jsx(je,{content:r,width:l,togglableOnFocus:!0,placement:"right",maxWidth:400,children:e.jsx(P,{mode:"tertiary",size:"small",color:"gray",icon:n.icon??"question-circle-regular",disabled:!0,style:[H.button,H.buttonWithDefaultCursor],ariaLabel:o("supportingDocuments.help.whatIsThis")})})).with({type:"button"},({label:r,onPress:l})=>e.jsx(P,{mode:"secondary",size:"small",color:"gray",icon:n.icon??"question-circle-regular",onPress:l,style:H.button,ariaLabel:o("supportingDocuments.help.whatIsThis"),children:r})).exhaustive(),ae=n=>q(n).with("fr",()=>"https://support.swan.io/hc/en-150/articles/22502977563933--Proof-of-registration-for-French-companies").with("it",()=>"https://support.swan.io/hc/en-150/articles/22537604831005--Proof-of-registration-for-Italian-companies").with("de",()=>"https://support.swan.io/hc/en-150/articles/22535023588509--Proof-of-registration-for-German-companies").with("es",()=>"https://support.swan.io/hc/en-150/articles/22544703221021--Proof-of-registration-for-Spanish-companies").with("nl",()=>"https://support.swan.io/hc/en-150/articles/22543228421277--Proof-of-registration-for-Dutch-companies").otherwise(()=>"https://support.swan.io/hc/en-150/articles/22620756787869-Proof-of-company-registration"),Ue=n=>{const r=`supportingDocuments.purpose.${n}`;return ue(r)?o(r):n},Ae=n=>{const r=`supportingDocuments.purpose.${n}.description`;return ue(r)?o(r):""},d=({ref:n,documents:r,generateUpload:l,uploadFile:k,requiredDocumentPurposes:I,templateLanguage:y=G.language,status:le,onChange:de,onRemoveFile:pe,showIds:me=!1,readOnly:_=!1,getPurposeMetadata:ce,readonlyDocumentPurposes:ge=[],purposeLabelOverrides:fe,purposeDescriptionLabelOverrides:ye})=>{const[we,Q]=i.useState(!1),[he,X]=i.useState(!1),[Y,Z]=i.useState(void 0),[R,ve]=i.useState([]),ee=i.useMemo(()=>{const t=new Set(I),u=[...R,...r];u.forEach(s=>t.add(s.purpose));const w=new Map([...t].map(s=>{const a=u.filter(p=>p.purpose===s);return[s,a]})),j=new Set(I),v=new Map([...t].map(s=>{const a=w.get(s)??[],D=a.length>0&&a.every(S=>S.file.statusInfo.status==="Validated")?0:j.has(s)?1:2;return[s,D]}));return[...t].sort((s,a)=>{const p=v.get(s)??2;return(v.get(a)??2)>p?-1:1}).map(s=>{const a=w.get(s)??[];return{purpose:s,files:a.map(p=>p.file),isRequired:j.has(s),areAllDocumentsValidated:v.get(s)===0}})},[I,r,R]),N=i.useRef(new Map(Pe.filterMap(ee,({isRequired:t,purpose:u,files:w})=>t?J.Some([u,w]):J.None()))),te=i.useRef({});i.useImperativeHandle(n,()=>({areAllRequiredDocumentsFilled:()=>[...N.current.values()].every(u=>u.length>0),addDocument:t=>{ve(u=>[...u,t])}})),i.useEffect(()=>{const t=R[R.length-1];if(t!=null){const u=te.current[t?.purpose];u?.add(t.file)}},[R]);const ne=ee.filter(({files:t})=>!(_&&t.length===0));return e.jsxs(ie,{children:[ne.map(({purpose:t,files:u,areAllDocumentsValidated:w,isRequired:j})=>{const v=ce?.(t),s=ye?.[t]??Ae(t);return e.jsxs(i.Fragment,{children:[e.jsx(se,{label:fe?.[t]??Ue(t),description:s,render:()=>e.jsxs(e.Fragment,{children:[e.jsxs(re,{direction:"row",children:[e.jsx(re,{direction:"row",children:z(v)?t==="CompanyRegistration"?e.jsxs(e.Fragment,{children:[e.jsx(P,{size:"small",mode:"secondary",icon:"question-circle-regular",onPress:()=>window.open(ae(G.language)),ariaLabel:o("supportingDocuments.help.howToSendAGoodDocument"),children:o("supportingDocuments.help.howToSendAGoodDocument")}),e.jsx(h,{width:8})]}):e.jsxs(e.Fragment,{children:[e.jsx(K,{type:"button",label:v.title,onPress:()=>Z(v)}),e.jsx(h,{width:8})]}):q(t).with("CompanyRegistration",()=>e.jsx(P,{size:"small",mode:"secondary",icon:"question-circle-regular",onPress:()=>window.open(ae(G.language)),ariaLabel:o("supportingDocuments.help.howToSendAGoodDocument"),children:o("supportingDocuments.help.howToSendAGoodDocument")})).otherwise(()=>null)}),q(t).with("PowerOfAttorney",()=>e.jsx(K,{type:"button",icon:"arrow-down-filled",label:o("supportingDocuments.help.downloadTemplate"),onPress:()=>Q(!0)})).with("SwornStatement",()=>e.jsx(K,{type:"button",icon:"arrow-down-filled",label:o("supportingDocuments.help.downloadTemplate"),onPress:()=>X(!0)})).otherwise(()=>null)]}),e.jsx(h,{height:16}),e.jsx(Ce,{ref:a=>{te.current[t]=a},canUpload:!ge.includes(t)&&!_&&le==="WaitingForDocument"&&!w,accept:Oe,maxSize:2e7,icon:"document-regular",initialFiles:u,generateUpload:l,getUploadConfig:a=>({fileName:a.name,purpose:t}),uploadFile:z(k)?k:({upload:a,file:p,onProgress:D})=>{const S=new FormData;return a.fields.forEach(({key:E,value:M})=>S.append(E,M)),S.append("file",p),setTimeout(()=>D(.8),100),be.make({url:a.url,method:"POST",body:S,type:"text"}).mapOkToResult(xe)},formatAndSizeDescription:o("supportingDocuments.documentTypes",{maxSizeMB:2e7/1e6}),onRemoveFile:_?void 0:pe,onChange:a=>{if(j){N.current.set(t,a);const p=N.current.entries().reduce((D,[S,E])=>{const M=E.map(De=>({purpose:S,file:De}));return D.push(...M),D},[]);de?.(p)}},showIds:me})]})}),e.jsx(h,{height:24})]},t)}),ne.length===0?e.jsxs(e.Fragment,{children:[e.jsx(h,{height:24}),e.jsx(W,{align:"center",children:o("supportingDocuments.noDocuments")}),e.jsx(h,{height:24})]}):null,e.jsxs($,{visible:we,title:o("supportingDocuments.powerOfAttorneyModal.title"),icon:"document-regular",onPressClose:()=>Q(!1),children:[e.jsx(W,{children:o("supportingDocuments.powerOfAttorneyModal.description")}),e.jsx(h,{height:16}),e.jsx(oe,{paddingBottom:0,children:e.jsx(P,{grow:!0,color:"current",onPress:()=>window.open(`/power-of-attorney-template/${q(y).with("fr",()=>"fr").with("de",()=>"de").with("es",()=>"es").with("it",()=>"it").otherwise(()=>"en")}.pdf`),children:o("supportingDocuments.downloadTemplate")})})]}),e.jsxs($,{visible:he,title:o("supportingDocuments.purpose.SwornStatement"),icon:"document-regular",onPressClose:()=>X(!1),children:[e.jsx(W,{children:o("supportingDocuments.purpose.SwornStatement.description")}),e.jsx(h,{height:16}),e.jsx(oe,{paddingBottom:0,children:e.jsx(P,{grow:!0,color:"current",onPress:()=>{window.open(`/sworn-statement-template/${q(y).with("nl",()=>"nl").with("es",()=>"es").with("it",()=>"it").otherwise(()=>"en")}.pdf`)},children:o("supportingDocuments.downloadTemplate")})})]}),e.jsx($,{visible:z(Y),title:o("supportingDocuments.informations"),icon:"document-regular",onPressClose:()=>Z(void 0),children:e.jsx(Fe,{children:Y?.values.map(({title:t,value:u,type:w},j)=>e.jsx(se,{type:"viewSmall",label:t,actions:w==="copy"&&e.jsx(Re,{valueToCopy:u,copiedText:o("copyButton.copiedTooltip"),copyText:o("copyButton.copyTooltip")}),render:()=>e.jsx(W,{variant:"regular",color:ke.gray[900],children:u})},`metadata-${j}`))})})]})};d.__docgenInfo={description:"",methods:[{name:"areAllRequiredDocumentsFilled",docblock:null,modifiers:[],params:[],returns:null},{name:"addDocument",docblock:null,modifiers:[],params:[{name:"document",optional:!1,type:null}],returns:null}],displayName:"SupportingDocumentCollection",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
...
}`,...B.parameters?.docs?.source}}};const yt=["WaitingForDocument","WaitingForDocumentShowIds","WaitingForDocumentWithApprovedAndRejected","Pending","Approved","ApprovedWithoutDownload","Rejected","ReadOnlyEmpty","ReadOnlyWithDocs"];export{O as Approved,U as ApprovedWithoutDownload,C as Pending,T as ReadOnlyEmpty,B as ReadOnlyWithDocs,A as Rejected,F as WaitingForDocument,b as WaitingForDocumentShowIds,x as WaitingForDocumentWithApprovedAndRejected,yt as __namedExportsOrder,ft as default};
//# sourceMappingURL=SupportingDocumentCollection.stories-DqjEZdMu.js.map
