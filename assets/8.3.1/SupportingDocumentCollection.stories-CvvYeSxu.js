import{m as Me,s as Ne,H as _e,G as Y,j as e,i as V,$ as _,h as He,S as q,L as A,c as Xe,n as ze,N as be,v as Ue}from"./Space-Bx5QDxXb.js";import{r as s}from"./index-BwDkhjyp.js";import{c as $e}from"./commonStyles-t4XfA7cz.js";import{a as Z,L as x}from"./LakeButton-Y-MEhM3X.js";import{L as Ge}from"./LakeCopyButton-BZBcP3KR.js";import{L as ee}from"./LakeLabel-e7hihA1w.js";import{R as Ke}from"./ReadOnlyFieldList-heTXAkwn.js";import{m as Je,d as Qe}from"./Request-TetOgKGf.js";import{t as u,l as Ye,i as Fe}from"./i18n-DbOmQyk3.js";import{F as Ze}from"./FilesUploader-3vYlUQku.js";import{L as M}from"./LakeModal-Da3qvbJU.js";import{S as d,a as m}from"./_StoriesComponents-AhKOd4N3.js";import"./extends-CCbyfPlC.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-B8XB3FuZ.js";import"./Pressable-Bn1ZMN3h.js";import"./index-CWXQFdbZ.js";import"./index-DGaDRGzj.js";import"./v4-CQkTLCs1.js";import"./rifm-Rmu9g2Q0.js";import"./utc-DJvBpWoA.js";import"./array-rjEBP2Ry.js";import"./FileInput-CW7OBWGA.js";import"./LakeHeading-BIJaJm8T.js";import"./useBoolean-DLYn8X0a.js";import"./index-D3ylJrlI.js";import"./LakeAlert-BJiPacQ3.js";import"./useResponsive-Dg25MDxx.js";import"./Tag-Bquq2Kwv.js";import"./index-COed5YRa.js";import"./FocusTrap-aGNEhBTL.js";import"./a11y-DXvpDVrG.js";import"./Suspendable-B5EH3QQQ.js";import"./ResponsiveContainer-BuP0WMvO.js";import"./TransitionView-oHMWxRhX.js";import"./useBodyClassName-Ds2flwH7.js";const H=s.memo(s.forwardRef(({style:a,onReset:n,onSubmit:o,...f},W)=>Me("form",{...f,ref:W,onReset:v=>{v.preventDefault(),n==null||n(v)},onSubmit:v=>{v.preventDefault(),o==null||o(v)},style:[$e.view,a]})));H.displayName="Form";H.__docgenInfo={description:"",methods:[],displayName:"Form"};const et=["application/pdf","image/png","image/jpeg"],N=Ne.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:"default"}}),C=a=>_(a).with({type:"tooltip"},({text:n,width:o})=>e.jsx(ze,{content:n,width:o,togglableOnFocus:!0,placement:"right",maxWidth:400,children:e.jsx(x,{mode:"tertiary",size:"small",color:"gray",icon:"question-circle-regular",disabled:!0,style:[N.button,N.buttonWithDefaultCursor],ariaLabel:u("supportingDocuments.help.whatIsThis")})})).with({type:"button"},({label:n,onPress:o})=>e.jsx(x,{mode:"tertiary",size:"small",color:"gray",icon:"question-circle-regular",onPress:o,style:N.button,ariaLabel:u("supportingDocuments.help.whatIsThis"),children:n})).exhaustive(),tt=a=>{const n=`supportingDocuments.purpose.${a}`;return Fe(n)?u(n):a},rt=a=>{const n=`supportingDocuments.purpose.${a}.description`;return Fe(n)?u(n):""},xe=({documents:a,generateUpload:n,uploadFile:o,requiredDocumentPurposes:f,templateLanguage:W=Ye.language,status:v,onRemoveFile:Oe,showIds:Te=!1,readOnly:L=!1,getPurposeMetadata:B,readonlyDocumentPurposes:Ee=[]},Ae)=>{const[Ce,X]=s.useState(!1),[We,z]=s.useState(!1),[O,$]=s.useState(void 0),[k,Le]=s.useState([]),G=s.useMemo(()=>{const t=new Set(f),i=[...k,...a];i.forEach(r=>t.add(r.purpose));const g=new Map([...t].map(r=>{const p=i.filter(y=>y.purpose===r);return[r,p]})),T=new Set(f),w=new Map([...t].map(r=>{const p=g.get(r)??[],E=p.length>0&&p.every(P=>P.file.statusInfo.status==="Validated")?0:T.has(r)?1:2;return[r,E]}));return[...t].sort((r,p)=>{const y=w.get(r)??2;return(w.get(p)??2)>y?-1:1}).map(r=>{const p=g.get(r)??[];return{purpose:r,files:p.map(y=>y.file),isRequired:T.has(r),areAllDocumentsValidated:w.get(r)===0}})},[f,a,k]),K=s.useRef(new Map(_e.filterMap(G,({isRequired:t,purpose:i,files:g})=>t?Y.Some([i,g]):Y.None()))),J=s.useRef({});s.useImperativeHandle(Ae,()=>({areAllRequiredDocumentsFilled:()=>[...K.current.values()].every(i=>i.length>0),addDocument:t=>{Le(i=>[...i,t])}})),s.useEffect(()=>{const t=k[k.length-1];if(t!=null){const i=J.current[t==null?void 0:t.purpose];i!=null&&i.add(t.file)}},[k]);const Q=G.filter(({files:t})=>!(L&&t.length===0));return e.jsxs(H,{children:[Q.map(({purpose:t,files:i,areAllDocumentsValidated:g,isRequired:T})=>{const w=B==null?void 0:B(t);return e.jsxs(s.Fragment,{children:[e.jsx(ee,{label:tt(t),help:V(w)?e.jsx(C,{type:"button",label:w.title,onPress:()=>$(w)}):_(t).with("PowerOfAttorney",()=>e.jsx(C,{type:"button",label:u("supportingDocuments.help.whatIsThis"),onPress:()=>X(!0)})).with("SwornStatement",()=>e.jsx(C,{type:"button",label:u("supportingDocuments.help.whatIsThis"),onPress:()=>z(!0)})).otherwise(()=>{const r=rt(t);return He(r)?e.jsx(C,{type:"tooltip",text:r}):null}),render:()=>e.jsx(Ze,{ref:r=>J.current[t]=r,canUpload:!Ee.includes(t)&&!L&&v==="WaitingForDocument"&&!g,accept:et,maxSize:2e7,icon:"document-regular",initialFiles:i,generateUpload:n,getUploadConfig:r=>({fileName:r.name,purpose:t}),uploadFile:V(o)?o:({upload:r,file:p,onLoadStart:y,onProgress:E})=>{const P=new FormData;return r.fields.forEach(({key:Be,value:Ve})=>P.append(Be,Ve)),P.append("file",p),Je.make({url:r.url,method:"POST",onLoadStart:y,onProgress:E,body:P}).mapOkToResult(Qe)},formatAndSizeDescription:u("supportingDocuments.documentTypes",{maxSizeMB:2e7/1e6}),onRemoveFile:L?void 0:Oe,onChange:r=>{T&&K.current.set(t,r)},showIds:Te})}),e.jsx(q,{height:24})]},t)}),Q.length===0?e.jsxs(e.Fragment,{children:[e.jsx(q,{height:24}),e.jsx(A,{align:"center",children:u("supportingDocuments.noDocuments")}),e.jsx(q,{height:24})]}):null,e.jsxs(M,{visible:Ce,title:u("supportingDocuments.powerOfAttorneyModal.title"),icon:"document-regular",onPressClose:()=>X(!1),children:[e.jsx(A,{children:u("supportingDocuments.powerOfAttorneyModal.description")}),e.jsx(q,{height:16}),e.jsx(Z,{paddingBottom:0,children:e.jsx(x,{grow:!0,color:"current",onPress:()=>window.open(`/power-of-attorney-template/${_(W).with("fr",()=>"fr").with("de",()=>"de").with("es",()=>"es").otherwise(()=>"en")}.pdf`),children:u("supportingDocuments.downloadTemplate")})})]}),e.jsxs(M,{visible:We,title:u("supportingDocuments.purpose.SwornStatement"),icon:"document-regular",onPressClose:()=>z(!1),children:[e.jsx(A,{children:u("supportingDocuments.purpose.SwornStatement.description")}),e.jsx(q,{height:16}),e.jsx(Z,{paddingBottom:0,children:e.jsx(x,{grow:!0,color:"current",onPress:()=>window.open("/sworn-statement-template/es.pdf"),children:u("supportingDocuments.downloadTemplate")})})]}),e.jsx(M,{visible:V(O),title:u("supportingDocuments.informations"),icon:"document-regular",onPressClose:()=>$(void 0),children:e.jsx(Ke,{children:O==null?void 0:O.values.map(({title:t,value:i,type:g})=>e.jsx(ee,{type:"viewSmall",label:t,actions:g==="copy"&&e.jsx(Ge,{valueToCopy:i,copiedText:u("copyButton.copiedTooltip"),copyText:u("copyButton.copyTooltip")}),render:()=>e.jsx(A,{variant:"regular",color:Xe.gray[900],children:i})}))})})]})},l=s.forwardRef(xe);xe.__docgenInfo={description:"",methods:[{name:"areAllRequiredDocumentsFilled",docblock:null,modifiers:[],params:[],returns:null},{name:"addDocument",docblock:null,modifiers:[],params:[{name:"document",optional:!1,type:null}],returns:null}],displayName:"SupportingDocumentCollectionWithRef",props:{status:{required:!0,tsType:{name:"union",raw:`| "WaitingForDocument"
| "PendingReview"
| "Approved"
| "Canceled"
...
//# sourceMappingURL=SupportingDocumentCollection.stories-CvvYeSxu.js.map
