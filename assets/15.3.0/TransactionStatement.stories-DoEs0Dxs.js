import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{F as n,L as r,M as i,N as a,R as o,U as s,ct as c,g as l,h as u,ht as d,i as f,it as p,kt as m,r as h,st as g,vt as _,wt as v}from"./ScrollView-BvY3QTy9.js";import{n as y,t as b}from"./Fill-XlUPfaRP.js";import{n as x,t as S}from"./Separator-e5jvPomq.js";import{a as C,s as w,t as T}from"./i18n-CDis1b5v.js";import{n as E,t as D}from"./Stack-CnR0IZeB.js";import{n as O,t as k}from"./SwanLogo-az0qd88V.js";import{n as A,t as j}from"./style-UWh_wwtb.js";import{n as M,r as N,t as P}from"./_StoriesComponents-BLODyyff.js";import{t as F}from"./iban-CvLLAFrO.js";var I,L,R,z,B,V,H,U,W,G=t((()=>{l(),y(),x(),f(),E(),O(),g(),n(),I=e(F()),d(),a(),C(),A(),L=s(),R=24,z=150,B=m.create({container:{height:1050,width:793,padding:56},partnershipText:{...j(`sans`,14),color:p.gray[500]},pageTitle:{...j(`sans`,20),color:p.swan[500],fontWeight:`600`},sectionTitle:{...j(`sans`,14),color:p.swan[500],fontWeight:`600`},lineName:{...j(`sans`,14),color:p.gray[700]},lineValue:{...j(`sans`,14),color:p.swan[500],fontWeight:`600`},generationInfos:{...j(`sans`,10),color:p.gray[700]},footer:{...j(`sans`,10),color:p.gray[500],fontWeight:`300`},defaultLogo:{height:R,width:45/10*R},swanLogo:{height:8,width:45/10*8,position:`relative`,top:.5}}),V=({name:e,value:t})=>(0,L.jsxs)(u,{direction:`row`,alignItems:`center`,children:[(0,L.jsx)(_,{style:B.lineName,children:e}),(0,L.jsx)(b,{minWidth:8}),(0,L.jsx)(_,{style:B.lineValue,children:t})]}),H={height:R,maxWidth:z,objectFit:`contain`,objectPosition:`left`},U=({partnerLogoUrl:e,generationDate:t,executionDate:n,type:a,amount:s,instructedAmount:c,amountCredited:l,targetTransferAmount:d,exchangeRate:f,fees:m,label:g,reference:y,debtorName:x,debtorAccountNumber:C,debtorBankName:E,debtorBankIdentifier:O,creditorName:A,creditorAccountNumber:j,creditorBankName:M,creditorBankIdentifier:N,style:P})=>(0,L.jsxs)(v,{style:[B.container,P],children:[(0,L.jsxs)(u,{direction:`row`,alignItems:`center`,children:[o(e)?(0,L.jsx)(`img`,{src:e,style:H}):(0,L.jsx)(k,{style:B.defaultLogo}),(0,L.jsx)(S,{horizontal:!0,space:8}),(0,L.jsx)(_,{style:B.partnershipText,children:w(`transactionStatement.partnership`)}),(0,L.jsx)(h,{width:4}),(0,L.jsx)(k,{color:p.gray[900],style:B.swanLogo})]}),(0,L.jsx)(h,{height:24}),(0,L.jsx)(_,{style:B.pageTitle,children:w(`transactionStatement.title.document`)}),(0,L.jsx)(h,{height:24}),(0,L.jsx)(_,{style:B.sectionTitle,children:w(`transactionStatement.title.transactionInformation`)}),(0,L.jsx)(h,{height:8}),(0,L.jsxs)(D,{space:8,children:[(0,L.jsx)(V,{name:w(`transactionStatement.information.executionDate`),value:n}),(0,L.jsx)(V,{name:w(`transactionStatement.information.type`),value:i(a).with(`SepaCreditTransferIn`,()=>w(`transactionStatement.type.SepaCreditTransferIn`)).with(`SepaCreditTransferOut`,()=>w(`transactionStatement.type.SepaCreditTransferOut`)).with(`SepaInstantCreditTransferIn`,()=>w(`transactionStatement.type.SepaInstantCreditTransferIn`)).with(`SepaInstantCreditTransferOut`,()=>w(`transactionStatement.type.SepaInstantCreditTransferOut`)).with(`InternalCreditTransferIn`,()=>w(`transactionStatement.type.InternalCreditTransferIn`)).with(`InternalCreditTransferOut`,()=>w(`transactionStatement.type.InternalCreditTransferOut`)).with(`InternationalCreditTransferIn`,()=>w(`transactionStatement.type.InternationalCreditTransferIn`)).with(`InternationalCreditTransferOut`,()=>w(`transactionStatement.type.InternationalCreditTransferOut`)).exhaustive()}),r(c)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.instructedAmount`),value:T(Number(c.value),c.currency)}),r(l)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.amountCredited`),value:T(Number(l.value),l.currency)}),r(s)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.amount`),value:T(Number(s.value),s.currency)}),r(d)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.targetTransferAmount`),value:T(Number(d.value),d.currency)}),r(f)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.exchangeRate`),value:`${T(Number(f[0].value),f[0].currency)} = ${T(Number(f[1].value),f[1].currency)}`}),r(m)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.fees`),value:T(Number(m.value),m.currency)}),(0,L.jsx)(V,{name:w(`transactionStatement.information.label`),value:g}),r(y)&&(0,L.jsx)(V,{name:w(`transactionStatement.information.reference`),value:y})]}),(0,L.jsx)(h,{height:24}),(0,L.jsx)(_,{style:B.sectionTitle,children:w(`transactionStatement.title.debtor`)}),(0,L.jsx)(h,{height:8}),(0,L.jsxs)(D,{space:8,children:[(0,L.jsx)(V,{name:w(`transactionStatement.debtor.name`),value:x}),(0,L.jsx)(V,{name:w(`transactionStatement.debtor.accountNumber`),value:I.default.isValid(C)?I.default.printFormat(C):C}),o(E)&&(0,L.jsx)(V,{name:w(`transactionStatement.debtor.bankName`),value:E}),o(O)&&(0,L.jsx)(V,{name:w(`transactionStatement.debtor.bankIdentifier`),value:O})]}),(0,L.jsx)(h,{height:24}),(0,L.jsx)(_,{style:B.sectionTitle,children:w(`transactionStatement.title.creditor`)}),(0,L.jsx)(h,{height:8}),(0,L.jsxs)(D,{space:8,children:[(0,L.jsx)(V,{name:w(`transactionStatement.creditor.name`),value:A}),(0,L.jsx)(V,{name:w(`transactionStatement.creditor.accountNumber`),value:I.default.isValid(j)?I.default.printFormat(j):j}),o(M)&&(0,L.jsx)(V,{name:w(`transactionStatement.creditor.bankName`),value:M}),o(N)&&(0,L.jsx)(V,{name:w(`transactionStatement.creditor.bankIdentifier`),value:N})]}),(0,L.jsx)(b,{minHeight:8}),(0,L.jsx)(_,{style:B.generationInfos,children:w(`transactionStatement.generationDate`,{date:t})}),(0,L.jsx)(h,{height:8}),i(a).with(`SepaCreditTransferOut`,`InternationalCreditTransferOut`,()=>(0,L.jsx)(_,{style:B.generationInfos,children:w(`transactionStatement.generationInfos`)})).otherwise(()=>null),(0,L.jsx)(S,{space:24}),(0,L.jsx)(_,{style:B.footer,children:w(`common.statement.footer`)})]}),W=e=>i(e).with({version:`v1`},e=>(0,L.jsx)(U,{...e})).exhaustive(),U.__docgenInfo={description:``,methods:[],displayName:`TransactionStatementV1`,props:{version:{required:!0,tsType:{name:`literal`,value:`"v1"`},description:``},partnerLogoUrl:{required:!1,tsType:{name:`string`},description:``},generationDate:{required:!0,tsType:{name:`string`},description:``},executionDate:{required:!0,tsType:{name:`string`},description:``},type:{required:!0,tsType:{name:`union`,raw:`| "SepaCreditTransferIn"
...
//# sourceMappingURL=TransactionStatement.stories-DoEs0Dxs.js.map