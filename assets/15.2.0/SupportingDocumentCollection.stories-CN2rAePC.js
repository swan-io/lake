import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{o as n}from"./iframe-lhskn-nq.js";import{A as r,C as i,D as a,E as o,Et as s,F as ee,L as c,M as l,N as te,O as u,P as d,U as f,g as ne,h as re,ht as p,i as ie,it as ae,kt as m,l as h,o as g,r as _,s as oe,st as v,u as y}from"./ScrollView-CDZwE4p9.js";import{n as b,t as x}from"./commonStyles-CaegYKO5.js";import{n as se,r as S,t as C}from"./LakeButton-CiAHUeEm.js";import{a as w,c as T,i as E,l as ce,o as D,u as le}from"./i18n-BW6EZZcX.js";import{n as ue,t as de}from"./LakeLabel-v4Ojq9Gb.js";import{n as fe,t as pe}from"./LakeCopyButton-D7BiCPmm.js";import{n as O,t as me}from"./ReadOnlyFieldList-DIFt5dez.js";import{n as k,r as he,t as A}from"./_StoriesComponents-B7hoikFh.js";import{n as ge,t as j}from"./LakeModal-DEu_OSIK.js";import{n as _e,t as ve}from"./FilesUploader-D-k8hSSW.js";var ye,M,be=t((()=>{ye=e(n()),p(),b(),M=(0,ye.memo)(({ref:e,style:t,onReset:n,onSubmit:r,...i})=>s(`form`,{...i,ref:e,onReset:e=>{e.preventDefault(),n?.(e)},onSubmit:e=>{e.preventDefault(),r?.(e)},style:[x.view,t]})),M.displayName=`Form`})),N,P,xe,F,I,L,R,Se=t((()=>{o(),ne(),be(),S(),fe(),ue(),oe(),y(),O(),ie(),v(),ee(),T(),N=e(n()),p(),te(),E(),_e(),ge(),P=f(),xe=[`application/pdf`,`image/png`,`image/jpeg`,`image/heic`],F=m.create({button:{opacity:1},buttonWithDefaultCursor:{opacity:1,cursor:`default`}}),I=e=>l(e).with({type:`tooltip`},({text:t,width:n})=>(0,P.jsx)(h,{content:t,width:n,togglableOnFocus:!0,placement:`right`,maxWidth:400,children:(0,P.jsx)(C,{mode:`tertiary`,size:`small`,color:`gray`,icon:e.icon??`question-circle-regular`,disabled:!0,style:[F.button,F.buttonWithDefaultCursor],ariaLabel:D(`supportingDocuments.help.whatIsThis`)})})).with({type:`button`},({label:t,onPress:n})=>(0,P.jsx)(C,{mode:`secondary`,size:`small`,color:`gray`,icon:e.icon??`question-circle-regular`,onPress:n,style:F.button,ariaLabel:D(`supportingDocuments.help.whatIsThis`),children:t})).exhaustive(),L=(e,t)=>l({language:e,country:t}).with(d.union({country:`FRA`},{country:d.nullish,language:`fr`}),()=>`https://support.swan.io/hc/${e}/articles/22502977563933`).with(d.union({country:`ITA`},{country:d.nullish,language:`it`}),()=>`https://support.swan.io/hc/${e}/articles/22537604831005`).with(d.union({country:`DEU`},{country:d.nullish,language:`de`}),()=>`https://support.swan.io/hc/${e}/articles/22535023588509`).with(d.union({country:`ESP`},{country:d.nullish,language:`es`}),()=>`https://support.swan.io/hc/${e}/articles/22544703221021`).with(d.union({country:`NLD`},{country:d.nullish,language:`nl`}),()=>`https://support.swan.io/hc/${e}/articles/22543228421277`).with(d.union({country:`BEL`}),()=>`https://support.swan.io/hc/${e}/articles/31233251462173`).otherwise(()=>`https://support.swan.io/hc/en-150/articles/22620756787869-Proof-of-company-registration`),R=({ref:e,documents:t,generateUpload:n,uploadFile:i,documentPurposes:a,templateLanguage:o=w.language,status:s,onChange:ee,onRemoveFile:te,showIds:d=!1,readOnly:f=!1,getPurposeMetadata:ne,companyCountry:p,readonlyDocumentPurposes:ie=[]})=>{let[m,h]=(0,N.useState)(!1),[oe,v]=(0,N.useState)(!1),[y,b]=(0,N.useState)(void 0),[x,S]=(0,N.useState)([]),T=(0,N.useMemo)(()=>{let e=new Set(Object.keys(a)),n=[...x,...t];return[...e].map(e=>{let t=n.filter(t=>t.purpose===e),r=t.length>0&&t.every(e=>e.file.statusInfo.status===`Validated`),i=a[e],o=i?.required===!0,s=r?0:o?1:2;return{purpose:e,files:t.map(e=>e.file),isRequired:o,areAllDocumentsValidated:r,priority:s,label:i?.label??e,description:i?.description,purposeDetails:i?.purposeDetails}}).sort((e,t)=>t.priority>e.priority?-1:1)},[a,t,x]),E=(0,N.useRef)(new Map(r.filterMap(T,({isRequired:e,purpose:t,files:n})=>e?u.Some([t,n]):u.None()))),ue=(0,N.useRef)({});(0,N.useImperativeHandle)(e,()=>({areAllRequiredDocumentsFilled:()=>[...E.current.values()].every(e=>e.length>0),addDocument:e=>{S(t=>[...t,e])}})),(0,N.useEffect)(()=>{let e=x[x.length-1];e!=null&&ue.current[e?.purpose]?.add(e.file)},[x]);let fe=T.filter(({files:e})=>!(f&&e.length===0)),O=T.find(({purpose:e})=>e===`SwornStatement`);return(0,P.jsxs)(M,{children:[fe.map(({purpose:e,files:t,areAllDocumentsValidated:r,isRequired:a,label:o,description:u,purposeDetails:ae})=>{let m=ne?.(e);return(0,P.jsxs)(N.Fragment,{children:[(0,P.jsx)(de,{label:o,description:ae??u,render:()=>(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(re,{direction:`row`,children:[(0,P.jsx)(re,{direction:`row`,children:c(m)?e===`CompanyRegistration`?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(C,{size:`small`,mode:`secondary`,icon:`question-circle-regular`,onPress:()=>window.open(L(w.language,p)),ariaLabel:D(`supportingDocuments.help.howToSendAGoodDocument`),children:D(`supportingDocuments.help.howToSendAGoodDocument`)}),(0,P.jsx)(_,{width:8})]}):(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(I,{type:`button`,label:m.title,onPress:()=>b(m)}),(0,P.jsx)(_,{width:8})]}):l(e).with(`CompanyRegistration`,()=>(0,P.jsx)(C,{size:`small`,mode:`secondary`,icon:`question-circle-regular`,onPress:()=>window.open(L(w.language,p)),ariaLabel:D(`supportingDocuments.help.howToSendAGoodDocument`),children:D(`supportingDocuments.help.howToSendAGoodDocument`)})).otherwise(()=>null)}),l(e).with(`PowerOfAttorney`,()=>(0,P.jsx)(I,{type:`button`,icon:`arrow-down-filled`,label:D(`supportingDocuments.help.downloadTemplate`),onPress:()=>h(!0)})).with(`SwornStatement`,()=>(0,P.jsx)(I,{type:`button`,icon:`arrow-down-filled`,label:D(`supportingDocuments.help.downloadTemplate`),onPress:()=>v(!0)})).otherwise(()=>null)]}),(0,P.jsx)(_,{height:16}),(0,P.jsx)(ve,{ref:t=>{ue.current[e]=t},canUpload:!ie.includes(e)&&!f&&s===`WaitingForDocument`&&!r,accept:xe,maxSize:2e7,icon:`document-regular`,initialFiles:t,generateUpload:n,getUploadConfig:t=>({fileName:t.name,purpose:e}),uploadFile:c(i)?i:({upload:e,file:t,onProgress:n})=>{let r=new FormData;return e.fields.forEach(({key:e,value:t})=>r.append(e,t)),r.append(`file`,t),setTimeout(()=>n(.8),100),ce.make({url:e.url,method:`POST`,body:r,type:`text`}).mapOkToResult(le)},formatAndSizeDescription:D(`supportingDocuments.documentTypes`,{maxSizeMB:2e7/1e6}),onRemoveFile:f?void 0:te,onChange:t=>{if(a){E.current.set(e,t);let n=E.current.entries().reduce((e,[t,n])=>{let r=n.map(e=>({purpose:t,file:e}));return e.push(...r),e},[]);ee?.(n)}},showIds:d})]})}),(0,P.jsx)(_,{height:24})]},e)}),fe.length===0?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(_,{height:24}),(0,P.jsx)(g,{align:`center`,children:D(`supportingDocuments.noDocuments`)}),(0,P.jsx)(_,{height:24})]}):null,(0,P.jsxs)(j,{visible:m,title:D(`supportingDocuments.powerOfAttorneyModal.title`),icon:`document-regular`,onPressClose:()=>h(!1),children:[(0,P.jsx)(g,{children:D(`supportingDocuments.powerOfAttorneyModal.description`)}),(0,P.jsx)(_,{height:16}),(0,P.jsx)(se,{paddingBottom:0,children:(0,P.jsx)(C,{grow:!0,color:`current`,onPress:()=>window.open(`/power-of-attorney-template/${l(o).with(`fr`,()=>`fr`).with(`de`,()=>`de`).with(`es`,()=>`es`).with(`it`,()=>`it`).otherwise(()=>`en`)}.pdf`),children:D(`supportingDocuments.downloadTemplate`)})})]}),(0,P.jsxs)(j,{visible:oe,title:O?.label??`Sworn Statement`,icon:`document-regular`,onPressClose:()=>v(!1),children:[(0,P.jsx)(g,{children:O?.description??``}),(0,P.jsx)(_,{height:16}),(0,P.jsx)(se,{paddingBottom:0,children:(0,P.jsx)(C,{grow:!0,color:`current`,onPress:()=>{window.open(`/sworn-statement-template/${l(o).with(`nl`,()=>`nl`).with(`es`,()=>`es`).with(`it`,()=>`it`).otherwise(()=>`en`)}.pdf`)},children:D(`supportingDocuments.downloadTemplate`)})})]}),(0,P.jsx)(j,{visible:c(y),title:D(`supportingDocuments.informations`),icon:`document-regular`,onPressClose:()=>b(void 0),children:(0,P.jsx)(me,{children:y?.values.map(({title:e,value:t,type:n},r)=>(0,P.jsx)(de,{type:`viewSmall`,label:e,actions:n===`copy`&&(0,P.jsx)(pe,{valueToCopy:t,copiedText:D(`copyButton.copiedTooltip`),copyText:D(`copyButton.copyTooltip`)}),render:()=>(0,P.jsx)(g,{variant:`regular`,color:ae.gray[900],children:t})},`metadata-${r}`))})})]})},R.__docgenInfo={description:``,methods:[{name:`areAllRequiredDocumentsFilled`,docblock:null,modifiers:[],params:[],returns:null},{name:`addDocument`,docblock:null,modifiers:[],params:[{name:`document`,optional:!1,type:null}],returns:null}],displayName:`SupportingDocumentCollection`,props:{ref:{required:!1,tsType:{name:`Ref`,elements:[{name:`signature`,type:`object`,raw:`{
...
//# sourceMappingURL=SupportingDocumentCollection.stories-CN2rAePC.js.map