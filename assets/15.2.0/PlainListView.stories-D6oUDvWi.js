import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{o as n}from"./iframe-BcHuJ41D.js";import{F as r,L as i,U as a,_ as o,g as s,h as c,ht as l,i as u,it as d,kt as f,n as p,nt as m,pt as h,r as g,rt as ee,st as _,t as te,v,wt as y,z as ne}from"./ScrollView-CrsrYS2O.js";import{n as b,t as x}from"./commonStyles-CaegYKO5.js";import{r as S,t as C}from"./LakeButton-CfcGvfCb.js";import{n as w,t as T}from"./Tag-DvVBujhA.js";import{r as E,t as D}from"./dist-DzH8jend.js";import{n as O,r as k}from"./LakeCheckbox-fqqV-1Pe.js";import{n as A,t as re}from"./LakeHeading-C2u3Pg7E.js";import{n as j,t as ie}from"./ResponsiveContainer-BFiOdF0r.js";import{a as M,c as N,n as P,r as F,s as I}from"./VirtualizedList-D732HsuI.js";var L,R,z,B,V,H,U,W,ae=t((()=>{L=e(n()),l(),b(),_(),o(),r(),A(),j(),p(),F(),R=a(),z=f.create({root:{height:1,alignSelf:`stretch`,flexGrow:1,backgroundColor:m.default},contentContainer:{flexDirection:`column`,alignItems:`stretch`,flexGrow:1},segment:{flexDirection:`row`,alignItems:`stretch`,overflow:`hidden`,paddingHorizontal:h[16]},segmentLarge:{paddingHorizontal:h[32]},row:{boxShadow:`inset 0 -1px ${d.gray[100]}`},activeRow:{backgroundColor:m.accented},hoveredRow:{backgroundColor:m.accented},segmentHeaderCell:{display:`flex`,flexDirection:`row`,alignItems:`center`},header:{position:`sticky`,top:0,flexDirection:`row`,alignItems:`stretch`,zIndex:2},stickyHeader:{position:`sticky`,backgroundColor:m.default90Transparency,backdropFilter:`blur(4px)`,zIndex:10,paddingHorizontal:h[24],flexDirection:`row`,alignItems:`center`},stickyHeaderLarge:{paddingHorizontal:h[40]},loadingPlaceholder:{position:`absolute`,left:0,right:0,top:0},rowLink:{color:`inherit`,textDecorationLine:`none`},emptyListContainer:{...x.fill,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:h[48],backgroundColor:m.default},scrollTracker:{pointerEvents:`none`,position:`absolute`,left:0,bottom:0,right:0}}),B=1,V=0,H=({id:e,item:t,index:n,rowHeight:r,columns:i,extraInfo:a,isActive:o,isHovered:s,large:c,style:l,onMouseEnter:u,onMouseLeave:d})=>{let f=(0,L.useRef)(null);return v(f,{onHoverStart:()=>u(e),onHoverEnd:()=>d()}),(0,R.jsx)(y,{ref:f,role:`row`,style:[z.segment,c&&z.segmentLarge,z.row,l?.(t,c),o&&z.activeRow,s&&z.hoveredRow,{minHeight:r}],children:i.map(({width:e,id:r,renderCell:i})=>(0,R.jsx)(y,{style:[z.segmentHeaderCell,{width:typeof e==`number`?e:B,flexGrow:e===`grow`?B:V}],id:r,children:i({columnId:r,item:t,index:n,extraInfo:a,isHovered:s})},r))})},U=({data:e,keyExtractor:t,rowHeight:n,groupHeaderHeight:r,headerHeight:a,columns:o,smallColumns:s=o,extraInfo:c,onEndReached:l,onEndReachedThresholdPx:u=200,headerStyle:d,rowStyle:f,getRowLink:p,activeRowId:h,renderEmptyList:g,onActiveRowChange:_,groupBy:v,loading:b,breakpoint:S=ee.large,withoutScroll:C=!1,stickyOffset:w=0,headerBackgroundColor:T=m.default})=>{let E=(0,L.useId)(),D=(0,L.useRef)(null),O=(0,L.useMemo)(()=>{if(v==null)return new Map([[null,e]]);let t=new Map;return e.forEach(e=>{let n=v(e);t.set(n,[...t.get(n)??[],e])}),t},[v,e]),k=n*e.length+O.size*r,A=i(b)&&b.isLoading,j=e.length===0,[M,N]=(0,L.useState)(void 0),P=(0,L.useCallback)(()=>{N(void 0)},[]);(0,L.useEffect)(()=>{let e=D.current;if(e!=null){let t=e,n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&i(l)&&l()})});return n.observe(t),()=>n.unobserve(t)}},[l]);let F=(0,L.useCallback)(({item:e,absoluteIndex:t,extraInfo:n})=>{let r=p?.({item:e,index:t,extraInfo:n});return ne(r)?(0,R.jsx)(y,{}):r},[p]),I=(0,L.useRef)(null);(0,L.useEffect)(()=>{let e=I.current;if(h!=null&&e!=null){let t=e;t.scrollIntoView({behavior:`smooth`,block:`nearest`}),_?.(t)}},[h,_]);let U=(0,L.useMemo)(()=>C?(0,R.jsx)(y,{style:z.contentContainer}):(0,R.jsx)(te,{scrollEventThrottle:32,contentContainerStyle:[z.contentContainer,{minHeight:k+(A?b.count*n:0)}]}),[A,b?.count,n,k,C]);return(0,R.jsx)(ie,{role:`table`,style:C?j?x.fill:void 0:z.root,breakpoint:S,children:({large:e})=>{let l=e?o:s;return(0,R.jsx)(R.Fragment,{children:(0,L.cloneElement)(U,{children:(0,R.jsxs)(R.Fragment,{children:[!j&&e?(0,R.jsx)(y,{role:`row`,style:[z.segment,z.segmentLarge,z.header,d,{backgroundColor:T}],children:l.map(({id:e,width:t,title:n,renderTitle:r})=>{let i=`${E}_${e}`;return(0,R.jsx)(y,{style:[z.segmentHeaderCell,{width:typeof t==`number`?t:B,flexGrow:t===`grow`?B:V,height:a}],id:i,children:r({title:n,extraInfo:c,id:e})},i)})}):null,(0,R.jsx)(y,{children:Array.from(O.entries()).map(([o,s])=>(0,R.jsxs)(L.Fragment,{children:[o==null?null:(0,R.jsx)(y,{style:[z.stickyHeader,e&&z.stickyHeaderLarge,{height:r,paddingTop:r/4,top:w+(e?a:0)}],children:(0,R.jsx)(re,{level:`none`,variant:`h3`,children:o})}),s.map((r,a)=>{let o=t(r,a),s=h===o,u=i(p)&&M===o,d=F({item:r,absoluteIndex:a,extraInfo:c});return(0,L.cloneElement)(d,{style:{...z.rowLink,...d.props.style},key:a,ref:s?I:null,children:(0,R.jsx)(H,{id:o,rowHeight:n,columns:l,item:r,index:a,extraInfo:c,isActive:s,isHovered:u,large:e,style:f,onMouseEnter:N,onMouseLeave:P})})})]},o))}),(0,R.jsx)(y,{children:(0,R.jsx)(y,{"aria-busy":A,style:z.loadingPlaceholder,children:A?(0,R.jsx)(W,{count:b.count,rowHeight:n}):null})}),j&&i(g)&&!A?(0,R.jsx)(y,{style:z.emptyListContainer,children:g()}):null,(0,R.jsx)(y,{style:[z.scrollTracker,{height:u}],ref:D})]})})})}})},W=P,U.__docgenInfo={description:``,methods:[],displayName:`PlainListView`,props:{data:{required:!0,tsType:{name:`Array`,elements:[{name:`T`}],raw:`T[]`},description:``},keyExtractor:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(item: T, index: number) => string`,signature:{arguments:[{type:{name:`T`},name:`item`},{type:{name:`number`},name:`index`}],return:{name:`string`}}},description:``},highlightedRowId:{required:!1,tsType:{name:`string`},description:``},headerHeight:{required:!0,tsType:{name:`number`},description:``},rowHeight:{required:!0,tsType:{name:`number`},description:``},groupHeaderHeight:{required:!0,tsType:{name:`number`},description:``},extraInfo:{required:!0,tsType:{name:`ExtraInfo`},description:``},columns:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string;
  width: number | "grow";
  title: string;
...
//# sourceMappingURL=PlainListView.stories-D6oUDvWi.js.map