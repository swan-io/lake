import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-BSRlePbn.js";import{Bt as r,Et as i,et as a,g as o,h as s,i as c,o as l,r as u,s as d}from"./ScrollView-CLxzqsu1.js";import{r as f,t as p}from"./_StoriesComponents-DyArIy4w.js";import{c as m,t as h}from"./countries-DfGfULkh.js";import{n as g,t as _}from"./Flag-E5rPvXRP.js";var v,y,b,x,S,C;t((()=>{o(),d(),c(),v=e(n()),i(),g(),m(),f(),y=a(),b=r.create({container:{flexWrap:`wrap`},flag:{flexBasis:`0%`,flexGrow:1,minWidth:250,padding:16}}),x={title:`Informations/Flag`,component:_},S=()=>{let e=(0,v.useMemo)(()=>[{name:`European Union`,code:`EU`},...h.map(({cca2:e,name:t})=>({name:t,code:e}))],[]);return(0,y.jsx)(p,{title:`Flag`,children:(0,y.jsx)(s,{direction:`row`,style:b.container,children:e.map(e=>(0,y.jsxs)(s,{alignItems:`center`,style:b.flag,children:[(0,y.jsx)(_,{code:e.code,width:18}),(0,y.jsx)(u,{height:4}),(0,y.jsx)(l,{align:`center`,variant:`smallMedium`,numberOfLines:1,children:e.name})]}))})})},S.__docgenInfo={description:``,methods:[],displayName:`Default`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`() => {
  const items = useMemo(() => [{
    name: "European Union",
    code: "EU" as const
  }, ...countries.map(({
...
//# sourceMappingURL=Flag.stories-CqittDOU.js.map