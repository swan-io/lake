import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{o as n}from"./iframe-D6oBoz4H.js";import{F as r,H as i,L as a,R as o,U as s,V as c,dt as l,g as u,gt as d,h as f,ht as p,i as m,it as h,kt as g,mt as _,o as v,pt as y,r as b,s as x,st as S,wt as C}from"./ScrollView-DH-yXGcG.js";import{n as w,t as T}from"./useBoolean-D40_llqV.js";import{r as E,t as D}from"./Pressable-rvj-0yg5.js";import{n as O,t as k}from"./Separator-CVGEJ8M8.js";import{n as A,t as j}from"./Popover-CxGPXmXw.js";import{n as M,t as N}from"./FlatList-Bl8QBFhO.js";import{r as P,t as F}from"./string-JUNbXrZq.js";import{c as I,o as L}from"./countries-DWlsIrMf.js";import{n as R,t as z}from"./Flag-DJrvKeyr.js";var B,V,H=t((()=>{B=e(n()),r(),V=(e,t)=>{let n=(0,B.useRef)(void 0);return(0,B.useCallback)(r=>(a(n.current)&&clearTimeout(n.current),n.current=window.setTimeout(e,t,r),()=>clearTimeout(n.current)),[e,t])}})),U,W,G,K,q,J=t((()=>{u(),M(),i(),x(),A(),E(),O(),m(),S(),T(),H(),r(),P(),U=e(n()),p(),I(),R(),W=s(),G=48,K=g.create({trigger:{alignItems:`center`,backgroundColor:h.gray[50],borderColor:h.gray[100],borderTopLeftRadius:l[4],borderTopRightRadius:l[4],borderBottomLeftRadius:l[4],borderBottomRightRadius:l[4],borderWidth:1,flexDirection:`row`,height:40,justifyContent:`center`,outlineStyle:`none`,paddingLeft:y[16],paddingRight:y[12],transitionDuration:`150ms`,transitionProperty:`background-color`},triggerPressed:{backgroundColor:h.gray[100]},triggerErrored:{borderColor:h.negative[500]},triggerDisabled:{borderColor:h.gray[50]},list:{height:230},listDropdown:{width:360},searchIcon:{position:`absolute`,left:16},searchInput:{..._.regular,color:h.gray[700],flexGrow:1,height:G,outlineStyle:`none`,paddingLeft:44},row:{flexDirection:`row`,alignItems:`center`,height:G,paddingHorizontal:16,transitionProperty:`background-color`,transitionDuration:`150ms`},rowHovered:{backgroundColor:h.gray[50]},rowPressed:{backgroundColor:h.gray[100]},rowName:{flexGrow:1}}),q=({value:e,onValueChange:t,countries:n,style:r,disabled:i=!1,readOnly:s=!1,error:l,ariaLabel:u=`Select country`})=>{let p=(0,U.useRef)(null),m=(0,U.useRef)(null),[g,{on:_,off:y}]=w(!1),x=(0,U.useMemo)(()=>n.filter((e,t,n)=>n.indexOf(e)===t).map(e=>L(e)),[n]),[S,T]=(0,U.useState)(x);(0,U.useEffect)(()=>{T(x)},[x]),(0,U.useEffect)(()=>{g&&setTimeout(()=>m.current?.focus(),250)},[g]);let E=V((0,U.useCallback)(e=>{let t=F(e.trim().toLowerCase());if(t===``){T(x);return}let n=x.filter(e=>e.deburr.includes(t)||e.idd.includes(t)||`+${e.idd}`.includes(t));T(n)},[x]),200);return(0,W.jsxs)(W.Fragment,{children:[(0,W.jsxs)(D,{ref:p,role:`button`,"aria-label":u,disabled:g||i||s,onPress:_,style:({pressed:e})=>[K.trigger,r,!g&&e&&K.triggerPressed,(i||s)&&K.triggerDisabled,o(l)&&K.triggerErrored],children:[(0,W.jsx)(z,{code:e.cca2,width:16}),(0,W.jsx)(b,{width:8}),(0,W.jsxs)(v,{color:h.gray[600],numberOfLines:1,userSelect:`none`,variant:`smallSemibold`,children:[`+`,e.idd]}),(0,W.jsx)(b,{width:8}),(0,W.jsx)(c,{name:`chevron-down-filled`,color:h.gray[600],size:16})]}),(0,W.jsx)(j,{referenceRef:p,visible:g,onDismiss:y,matchReferenceWidth:!1,children:({mode:n})=>(0,W.jsxs)(C,{style:[K.list,n===`dropdown`&&K.listDropdown],children:[(0,W.jsxs)(f,{direction:`row`,alignItems:`center`,children:[(0,W.jsx)(c,{name:`search-filled`,color:h.gray[300],size:18,style:K.searchIcon}),(0,W.jsx)(d,{ref:m,inputMode:`search`,style:K.searchInput,onChangeText:E,onSubmitEditing:()=>{a(S[0])&&(t(S[0]),y())}})]}),(0,W.jsx)(k,{}),(0,W.jsx)(N,{data:S,ItemSeparatorComponent:(0,W.jsx)(k,{}),keyExtractor:e=>e.uid,renderItem:({item:n})=>(0,W.jsxs)(D,{role:`button`,"aria-label":n.name,style:({hovered:e,pressed:t})=>[K.row,e&&K.rowHovered,t&&K.rowPressed],onPress:()=>{t(n),y()},children:[(0,W.jsx)(z,{code:n.cca2,width:16}),(0,W.jsx)(b,{width:12}),(0,W.jsx)(v,{numberOfLines:1,style:K.rowName,userSelect:`none`,variant:`smallRegular`,children:n.name}),n.uid===e.uid&&(0,W.jsxs)(W.Fragment,{children:[(0,W.jsx)(b,{width:12}),(0,W.jsx)(c,{name:`checkmark-filled`,color:h.positive[500],size:16})]}),(0,W.jsx)(b,{width:12}),(0,W.jsxs)(v,{userSelect:`none`,variant:`smallRegular`,children:[`+`,n.idd]})]})})]})})]})},q.__docgenInfo={description:``,methods:[],displayName:`PhoneCountryPicker`,props:{value:{required:!0,tsType:{name:`Simplify`,elements:[{name:`intersection`,raw:`Pick<(typeof readonlyCountries)[number], "cca2" | "cca3"> & {
  name: string;
  deburr: string;
  idd: string;
  uid: string;
...
//# sourceMappingURL=PhoneCountryPicker-BXpPmB5Z.js.map