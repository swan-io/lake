import{j as e,B,S,L as I,c as C,h as L,s as w,V as D}from"./ScrollView-D62ibAIB.js";import{a as A}from"./LakeButton-BfOCm3fg.js";import{L as E}from"./LakeLabel-BIJxdTnD.js";import{u as W}from"./index-CGF7HGax.js";import{L as _}from"./LakeTextInput-Bpj-pEP2.js";import{r as k}from"./iframe-BxiObLlT.js";import{p as O,b as N}from"./countries-BUkqG1ou.js";import{P as z}from"./PhoneCountryPicker-DHkv-5AD.js";import{S as G,a as t}from"./_StoriesComponents-BQs9RYw8.js";import"./index-CXGbStiX.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-IuiObHup.js";import"./index-7aTJbVC5.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-B5oZAGif.js";import"./LakeSelect-79P_dD7R.js";import"./i18n-BAHhLTkf.js";import"./array-BfAlyugE.js";import"./useBoolean-IZ-pDfSv.js";import"./useDisclosure-CExXvzVx.js";import"./FocusTrap-DTttPBR6.js";import"./FlatList-K59-7HEL.js";import"./Popover-CKRxTEUe.js";import"./useResponsive-IDrYkp5e.js";import"./function-B0aMUF-W.js";import"./BottomPanel-B7iD4gNe.js";import"./useBodyClassName-Dom7l_Fe.js";import"./Suspendable-CExqBWGX.js";import"./TransitionView-C3qvf9TQ.js";import"./index-Bgg291J9.js";import"./Separator-Bt5trxzM.js";import"./preload-helper-D1IIBeq1.js";import"./string-D-ZtbIgs.js";import"./Flag-D9-Tfjz4.js";const j=w.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:c,id:d,country:m,value:p,countries:y,error:a,help:g,valid:f=!1,autofocus:r=!1,disabled:n=!1,readOnly:o=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:P,onSubmitEditing:s,onBlur:T})=>{const u=k.useRef(null),R=x=>{const F=x.replace(/[^ +0-9-()]/g,"");x===F&&P(x)};k.useEffect(()=>{r&&u.current&&setTimeout(()=>u.current?.focus(),250)},[r,m]),k.useImperativeHandle(c,()=>({focus:()=>u.current?.focus(),blur:()=>u.current?.blur()}),[]);const V=[j.picker,(n||o)&&j.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:m,countries:y??O,onValueChange:v,disabled:n,readOnly:o,error:a,ariaLabel:b,style:V}),e.jsx(_,{id:d,ref:u,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:p,valid:f,error:a,disabled:n,readOnly:o,onChangeText:R,onSubmitEditing:s,onBlur:T,style:j.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(S,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(a)?C.negative[500]:C.gray[500],children:a??g??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-JIC9OD6H.js.map
