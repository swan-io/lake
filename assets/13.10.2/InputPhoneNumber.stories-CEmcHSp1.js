import{j as e,B,S,L as I,c as C,h as L,s as w,V as D}from"./ScrollView-SDdqIOjG.js";import{a as A}from"./LakeButton-Z42kTch1.js";import{L as E}from"./LakeLabel-nZWJGaDB.js";import{u as W}from"./index-oU2RjJEy.js";import{L as _}from"./LakeTextInput-BCPDPn0d.js";import{r as k}from"./iframe-D1duQp2Q.js";import{p as O,b as N}from"./countries-BM4NRJhs.js";import{P as z}from"./PhoneCountryPicker-Cr4ZCRmW.js";import{S as G,a as t}from"./_StoriesComponents-BKqBt6LL.js";import"./index-CoghPqk4.js";import"./commonStyles-BBEkV6IC.js";import"./Pressable-BXC_w4K0.js";import"./index-CROAzjyK.js";import"./extends-CF3RwP-h.js";import"./v4-EwEgHOG0.js";import"./Fill-BAb3zIbx.js";import"./LakeSelect-Cre_9ItZ.js";import"./useBoolean-Zq0uUxiC.js";import"./useDisclosure-CK85EONc.js";import"./FocusTrap-ChDM9kaO.js";import"./array-BfAlyugE.js";import"./FlatList-E6T6YxzF.js";import"./Popover-CIY6hkFn.js";import"./useResponsive-B1jxFPrI.js";import"./function-B0Qs1cNd.js";import"./BottomPanel-BDhDkoZe.js";import"./useBodyClassName-CwVo92do.js";import"./Suspendable-BAg_Tsnt.js";import"./TransitionView-CP4urHtg.js";import"./index-BXHitgjZ.js";import"./Separator-PPSvpwsX.js";import"./preload-helper-D1IIBeq1.js";import"./string-zHlS45FS.js";import"./i18n-BC6NtV_f.js";import"./rifm-DDCet3-J.js";import"./Flag-CagU6YvR.js";const j=w.create({picker:{borderTopRightRadius:0,borderBottomRightRadius:0,borderRightWidth:0},pickerDisabled:{borderRightWidth:1,borderRightColor:C.gray[100]},input:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}),q=({ref:c,id:d,country:m,value:p,countries:y,error:a,help:g,valid:f=!1,autofocus:r=!1,disabled:n=!1,readOnly:o=!1,countryAriaLabel:b,hideErrors:h=!1,onCountryChange:v,onChangeText:P,onSubmitEditing:s,onBlur:T})=>{const u=k.useRef(null),R=x=>{const F=x.replace(/[^ +0-9-()]/g,"");x===F&&P(x)};k.useEffect(()=>{r&&u.current&&setTimeout(()=>u.current?.focus(),250)},[r,m]),k.useImperativeHandle(c,()=>({focus:()=>u.current?.focus(),blur:()=>u.current?.blur()}),[]);const V=[j.picker,(n||o)&&j.pickerDisabled];return e.jsxs(e.Fragment,{children:[e.jsxs(B,{direction:"row",children:[e.jsx(z,{value:m,countries:y??O,onValueChange:v,disabled:n,readOnly:o,error:a,ariaLabel:b,style:V}),e.jsx(_,{id:d,ref:u,autoComplete:"tel",inputMode:"tel",rows:1,hideErrors:!0,value:p,valid:f,error:a,disabled:n,readOnly:o,onChangeText:R,onSubmitEditing:s,onBlur:T,style:j.input})]}),!h&&e.jsxs(e.Fragment,{children:[e.jsx(S,{height:4}),e.jsx(I,{variant:"smallRegular",color:L(a)?C.negative[500]:C.gray[500],children:a??g??" "})]})]})};q.__docgenInfo={description:"",methods:[{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"InputPhoneNumber",props:{ref:{required:!1,tsType:{name:"Ref",elements:[{name:"signature",type:"object",raw:`{
  focus: () => void;
  blur: () => void;
...
//# sourceMappingURL=InputPhoneNumber.stories-CEmcHSp1.js.map
