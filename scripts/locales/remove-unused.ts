...
const removeUnusedKeysInClient = (client: (typeof packages)[number]) => {
  const localePath = path.resolve(__dirname, `../../packages/${client}/src/locales`);
